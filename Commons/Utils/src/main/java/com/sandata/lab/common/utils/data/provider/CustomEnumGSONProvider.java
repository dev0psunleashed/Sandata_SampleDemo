...
public class CustomEnumGSONProvider implements MessageBodyReader<Object>, MessageBodyWriter<Object> {
    ...
    public CustomEnumGSONProvider() {
        dateTimeFormat = DateUtil.SANDATA_UTC_DATE_TIME_FORMAT;
    }

    public CustomEnumGSONProvider(final String format) {
    ...
    public static Gson getFromGson() {
        if(_fromJson == null)
            _fromJson = new GsonBuilder()
                    ...
                    .registerTypeAdapter(LocalDateTime.class, new CustomLocalDateTimeAdapter())
                    .registerTypeAdapter(Date.class, new CustomJavaDateAdapter(dateTimeFormat))
                    .registerTypeHierarchyAdapter(Enum.class, new CustomEnumJavaAdapter())
                    .create();
