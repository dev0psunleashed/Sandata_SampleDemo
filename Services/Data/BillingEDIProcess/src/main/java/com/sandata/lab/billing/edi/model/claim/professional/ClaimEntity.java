...
public class ClaimEntity {
    ...
    private Collection<ClaimEntityContact> contacts;
    ...
    public Collection<ClaimEntityContact> getContacts() {
        return contacts;
    }

    public void setContacts(Collection<ClaimEntityContact> contacts) {
