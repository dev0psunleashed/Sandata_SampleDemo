...
public class BillingDetailHeaderExt extends InvoiceFindResult {
    ...
    private List<BillingDetailExt> billingDetailServiceLineItems;
    ...
    public List<BillingDetailExt> getBillingDetailServiceLineItems() {
        return billingDetailServiceLineItems;
    }

    public void setBillingDetailServiceLineItems(List<BillingDetailExt> billingDetailServiceLineItems) {
