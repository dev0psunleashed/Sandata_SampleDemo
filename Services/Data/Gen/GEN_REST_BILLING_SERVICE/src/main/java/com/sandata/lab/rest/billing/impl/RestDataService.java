...
import com.sandata.lab.rest.billing.api.DataService;
...
public class RestDataService implements DataService {
        ...
        try {
            ...
            if (bShouldInsert) {
                ...
                if (data instanceof Billing) {
                    returnVal = ((Billing) data).getBillingSK().longValue();
                }
    ...
    public void getPayerContracts(final Exchange exchange) throws SandataRuntimeException {
        ...
        try {
            ...
            Response response = oracleDataService.getPayerContracts(bsnEntID);
    ...
    public void getBillingRatePK(final Exchange exchange) throws SandataRuntimeException {
        ...
        try {
            ...
            exchange.getIn().setBody(oracleDataService.getBillingRatePK(patientId, bsnEntId));
