package com.sandata.lab.rest.sched.utils.templates;
...
public class ProducerPojo {
    ...
    private void buildProducerTemplate(Exchange exchange){
      if(exchange == null || exchange.getContext() == null){
          throw new SandataRuntimeException("ProducerPojo: the input Exchange cannot be null");
      }
