SELECT * FROM (SELECT ROWNUM ROW_NUMBER, COUNT(*) OVER() TOTAL_ROWS, R1.* FROM (
  SELECT * FROM (
    (SELECT DISTINCT T1.PT_ID,T1.PT_SK,T1.BE_ID,T1.PT_FIRST_NAME,T1.PT_LAST_NAME,T1.PT_MIDDLE_NAME,T1.PT_DOB,
    ...
    --
      ...
      (UPPER(T1.PT_FIRST_NAME) LIKE 'RUT%' OR UPPER(T1.PT_LAST_NAME) LIKE 'RUT%') AND
