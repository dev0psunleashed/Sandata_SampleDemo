package com.sandata.lab.rest.ar.api;
...
public interface OracleService {
    ...
    Object executeGet(String packageName, String methodName, String className, String bsnEntId) throws SandataRuntimeException;
