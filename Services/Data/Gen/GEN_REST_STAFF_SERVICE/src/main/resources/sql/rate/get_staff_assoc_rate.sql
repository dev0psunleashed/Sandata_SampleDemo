SELECT T4.SVC_UNIT_NAME,T4.BE_RATE_SK,T4.BE_RATE_AMT,T4.BE_RATE_EFF_DATE,T4.BE_RATE_TERM_DATE,
...
WHERE T1.STAFF_ID = '20160822103404248' AND T1.BE_ID = '1' AND T1.RATE_QLFR_CODE = 'PAY' AND BE_RATE_SK IS NOT NULL
