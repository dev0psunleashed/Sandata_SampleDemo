...
FROM
  ...
  FROM
    ...
    INNER JOIN
      ...
      FROM SCHED_EVNT
      WHERE SCHED_EVNT_START_DTIME BETWEEN TO_DATE('2016-08-10 01:00', 'YYYY-MM-DD HH24:MI') AND TO_DATE('2016-08-10 23:00', 'YYYY-MM-DD HH24:MI')
      ) T7
    ...
    WHERE T1.BE_ID                                = 1
    AND T9.SVC_NAME                               = 'RN'
    AND T1.STAFF_POSITION_NAME                    = 'RN'
    AND UPPER(T1.STAFF_EMPLT_STATUS_TYP_NAME)    IN ( 'ACTIVE' )
