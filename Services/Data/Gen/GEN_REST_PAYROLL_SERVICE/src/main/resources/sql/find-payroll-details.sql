  ...
  (SELECT ROWNUM ROW_NUMBER, COUNT(*) OVER() TOTAL_ROWS, R1.* FROM (
      SELECT DISTINCT * FROM (
        ...
        FROM PR_INPUT T1
          ...
          WHERE CHECK_NUM IS NOT NULL AND

          T1.WEEK_END_DATE BETWEEN TO_DATE('2015-11-25', 'YYYY-MM-DD') AND
         TO_DATE('2016-12-31', 'YYYY-MM-DD') AND
        ...
        ORDER BY UPPER(STAFF_LAST_NAME) ASC
