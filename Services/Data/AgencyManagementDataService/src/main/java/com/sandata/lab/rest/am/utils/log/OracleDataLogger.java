...
package com.sandata.lab.rest.am.utils.log;
...
public class OracleDataLogger extends SandataLogger {
    ...
    public static SandataLogger CreateLogger(final Exchange exchange, final CamelContext camelContext) {

        return new OracleDataLogger(exchange, camelContext);
    }

    private OracleDataLogger(final Exchange exchange, final CamelContext camelContext) {
        super(exchange, camelContext);
    }

    @Override
    public String processName() {
        return "OracleDataLogger:sandata-rest-am-data-service";
    }
