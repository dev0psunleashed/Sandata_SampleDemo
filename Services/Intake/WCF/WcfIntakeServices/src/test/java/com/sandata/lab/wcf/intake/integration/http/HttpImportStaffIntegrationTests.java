...
/**
 * Tests the integration of WCF REST call for Staff.
 * <p/>
 *
 * @author David Rutgos
 */
public class HttpImportStaffIntegrationTests extends BaseIntegrationTestSupport {

    @Test
    public void should_return_wcf_response_after_performing_import_staff() throws Exception {
        ...
        String result = service.post(String.format("%s/ImportStaff", url), json, contentType);
