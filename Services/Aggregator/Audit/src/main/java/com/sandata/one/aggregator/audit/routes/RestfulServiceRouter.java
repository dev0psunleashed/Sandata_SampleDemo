...
package com.sandata.one.aggregator.audit.routes;

import com.sandata.lab.common.utils.camel.AbstractRouteBuilder;
import com.sandata.lab.common.utils.messaging.Messaging;
import com.sandata.one.aggregator.audit.utils.constants.App;
...
public class RestfulServiceRouter extends AbstractRouteBuilder {
    ...
    protected void buildRoute() {
        ...
        from(Messaging.Names.CXFRS + "rsServer?bindingStyle=SimpleConsumer")
                ...
                .threads().executorServiceRef("aggregatorAuditThreadPool")
