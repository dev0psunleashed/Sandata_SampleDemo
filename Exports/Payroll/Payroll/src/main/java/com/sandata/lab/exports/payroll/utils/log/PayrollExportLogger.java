...
package com.sandata.lab.exports.payroll.utils.log;
...
// TODO: Delete/Rename ...
public class PayrollExportLogger extends SandataLogger {

    private static Logger logger = LoggerFactory.getLogger("PayrollImportLogger");

    public static SandataLogger CreateLogger() {

        return new PayrollExportLogger();
    }

    public static SandataLogger CreateLogger(final Exchange exchange) {

        return new PayrollExportLogger(exchange);
    }

    private PayrollExportLogger() {
        super();
    }

    private PayrollExportLogger(final Exchange exchange) {
        super(exchange);
    }
