...
{
	[DataContract]
	public class StaffAdministrativeAssessment
	{

			[DataMember(IsRequired = true)]
			public long StaffAdministrativeAssessmentSK { get; set; }

			[DataMember(IsRequired = true)]
			public String StaffAdministrativeAssessmentID { get; set; }
			...
			[IgnoreDataMember]
			public Nullable<DateTime> AdministrativeEvaluationDate { get; set; }

			[DataMember(Name = "AdministrativeEvaluationDate")]
			public string AdministrativeEvaluationDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(AdministrativeEvaluationDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						AdministrativeEvaluationDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}

			[IgnoreDataMember]
			public Nullable<DateTime> SupervisoryVisitDate { get; set; }

			[DataMember(Name = "SupervisoryVisitDate")]
			public string SupervisoryVisitDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(SupervisoryVisitDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						SupervisoryVisitDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}
