...
{
	[DataContract]
	public class PatientClinicalAssessment
	{

			[DataMember(IsRequired = true)]
			public long PatientClinicalAssessmentSK { get; set; }

			[DataMember(IsRequired = true)]
			public String PatientClinicalAssessmentID { get; set; }
			...
			[DataMember]
			public String PatientFunctionalAbilities { get; set; }
