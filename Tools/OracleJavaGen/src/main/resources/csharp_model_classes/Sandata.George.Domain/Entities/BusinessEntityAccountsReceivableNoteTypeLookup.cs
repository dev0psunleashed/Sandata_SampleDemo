...
{
	[DataContract]
	public class BusinessEntityAccountsReceivableNoteTypeLookup
	{
			...
			public long BusinessEntityAccountsReceivableNoteTypeLookupSK { get; set; }
			...
			[DataMember]
			public String AccountsReceivableNoteTypeDescription { get; set; }
