...
{
	[DataContract]
	public class PatientRequirement
	{

			[DataMember(IsRequired = true)]
			public long PatientRequirementSK { get; set; }

			[DataMember(IsRequired = true)]
			public String PatientRequirementID { get; set; }
			...
			[DataMember]
			public String StaffSpecialtyTraining { get; set; }

			[DataMember]
			public String PatientRestrictionComment { get; set; }
