...
{
	[DataContract]
	public class BusinessEntityReferenceFormatLookup
	{

			[DataMember(IsRequired = true)]
			public long BusinessEntityReferenceFormatLookupSK { get; set; }
			...
			[DataMember]
			public String ReferenceFormatDescription { get; set; }
