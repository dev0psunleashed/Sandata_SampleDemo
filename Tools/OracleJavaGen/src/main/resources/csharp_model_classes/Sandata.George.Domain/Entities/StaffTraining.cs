...
namespace Sandata.George.Domain.Entities
{
	...
	public class StaffTraining
	{
			...
			public long StaffTrainingSK { get; set; }
			...
			[IgnoreDataMember]
			public Nullable<DateTime> StaffTrainingEnrolledDate { get; set; }

			[DataMember(Name = "StaffTrainingEnrolledDate")]
			public string StaffTrainingEnrolledDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(StaffTrainingEnrolledDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						StaffTrainingEnrolledDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}

			[DataMember]
			public String StaffTrainingResultCode { get; set; }
