...
{
	[DataContract]
	public class BusinessEntityEmploymentClassLookup
	{
			...
			public long BusinessEntityEmploymentClassLookupSK { get; set; }
			...
			[DataMember(IsRequired = true)]
			public String EmploymentClassName { get; set; }

			[DataMember]
			public String EmploymentClassDescription { get; set; }
