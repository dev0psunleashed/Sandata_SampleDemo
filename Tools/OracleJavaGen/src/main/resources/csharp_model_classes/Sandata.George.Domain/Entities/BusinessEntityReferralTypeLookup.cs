...
{
	[DataContract]
	public class BusinessEntityReferralTypeLookup
	{

			[DataMember]
			public List<Referral> ReferralPropertyCollection { get; set; }

			[DataMember(IsRequired = true)]
			public long BusinessEntityReferralTypeLookupSK { get; set; }
