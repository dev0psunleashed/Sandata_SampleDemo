...
{
	[DataContract]
	public class CountySubdivisionLookup
	{
			...
			public long CountySubdivisionLookupSK { get; set; }
			...
			[DataMember]
			public String CountySubdivisionFederalInformationProcessingStandardCode { get; set; }

			[DataMember(IsRequired = true)]
			public CountySubdivisionQualifier CountySubdivisionQualifier { get; set; }
			...
			[DataMember]
			public String CountySubdivisionFunctionalStatusCode { get; set; }
