...
{
	[DataContract]
	public class BusinessEntitySkillLookup
	{

			[DataMember(IsRequired = true)]
			public long BusinessEntitySkillLookupSK { get; set; }
			...
			[IgnoreDataMember]
			public Nullable<DateTime> SkillEffectiveDate { get; set; }

			[DataMember(Name = "SkillEffectiveDate")]
			public string SkillEffectiveDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(SkillEffectiveDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						SkillEffectiveDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}

			[IgnoreDataMember]
			public Nullable<DateTime> SkillTerminationDate { get; set; }

			[DataMember(Name = "SkillTerminationDate")]
			public string SkillTerminationDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(SkillTerminationDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						SkillTerminationDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}
