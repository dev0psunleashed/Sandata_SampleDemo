...
{
	[DataContract]
	public class BusinessEntityLineOfBusinessLookup
	{
			...
			public long BusinessEntityLineofBusinessLookupSK { get; set; }
			...
			[DataMember(IsRequired = true)]
			public String BusinessEntityLineofBusinessProperty { get; set; }

			[DataMember]
			public String BusinessEntityLineofBusinessDescription { get; set; }

			[IgnoreDataMember]
			public Nullable<DateTime> BusinessEntityLineofBusinessEffectiveDate { get; set; }

			[DataMember(Name = "BusinessEntityLineofBusinessEffectiveDate")]
			public string BusinessEntityLineofBusinessEffectiveDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(BusinessEntityLineofBusinessEffectiveDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						BusinessEntityLineofBusinessEffectiveDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}

			[IgnoreDataMember]
			public Nullable<DateTime> BusinessEntityLineofBusinessTerminationDate { get; set; }

			[DataMember(Name = "BusinessEntityLineofBusinessTerminationDate")]
			public string BusinessEntityLineofBusinessTerminationDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(BusinessEntityLineofBusinessTerminationDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						BusinessEntityLineofBusinessTerminationDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}
