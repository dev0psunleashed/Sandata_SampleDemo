...
{
	[DataContract]
	public class AuthorizationLimitUnitLookup
	{

			[DataMember(IsRequired = true)]
			public long AuthorizationLimitUnitLookupSK { get; set; }
			...
			[DataMember(IsRequired = true)]
			public AuthorizationServiceUnitName AuthorizationLimitUnitName { get; set; }

			[DataMember]
			public String AuthorizationLimitUnitDescription { get; set; }
