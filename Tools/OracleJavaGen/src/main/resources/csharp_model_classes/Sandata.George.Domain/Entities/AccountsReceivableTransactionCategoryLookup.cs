...
{
	[DataContract]
	public class AccountsReceivableTransactionCategoryLookup
	{

			[DataMember]
			public List<AccountsReceivableTransactionLookup> AccountsReceivableTransactionLookupCollection { get; set; }

			[DataMember(IsRequired = true)]
			public long AccountsReceivableTransactionCategoryLookupSK { get; set; }
			...
			[DataMember]
			public String AccountsReceivableTransactionCategoryDescription { get; set; }
