...
{
	[DataContract]
	public class AccountsReceivableTransactionLookup
	{
			...
			public long AccountsReceivableTransactionLookupSK { get; set; }
			...
			[DataMember]
			public String AccountsReceivableTransactionName { get; set; }

			[DataMember]
			public String AccountsReceivableTransactionDescription { get; set; }

			[DataMember]
			public AccountingTransactionSignQualifier AccountsReceivableTransactionSignQualifier { get; set; }

			[DataMember]
			public AccountsReceivableTransactionCategoryCode AccountsReceivableTransactionCategoryCode { get; set; }
