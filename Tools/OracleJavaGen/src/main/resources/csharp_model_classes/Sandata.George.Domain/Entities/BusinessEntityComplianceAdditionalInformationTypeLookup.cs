...
{
	[DataContract]
	public class BusinessEntityComplianceAdditionalInformationTypeLookup
	{
			...
			public long BusinessEntityComplianceAdditionalInformationTypeLookupSK { get; set; }
			...
			[DataMember]
			public String ComplianceAdditionalInformationTypeDescription { get; set; }
