...
{
	[DataContract]
	public class VisitEventTypeLookup
	{

			[DataMember]
			public List<VisitEvent> VisitEventPropertyCollection { get; set; }

			[DataMember(IsRequired = true)]
			public long VisitEventTypeLookupSK { get; set; }
			...
			[DataMember]
			public String VisitEventTypeDescription { get; set; }
