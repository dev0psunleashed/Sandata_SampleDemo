...
{
	[DataContract]
	public class PayerSubTypeLookup
	{

			[DataMember]
			public List<Payer> PayerPropertyCollection { get; set; }

			[DataMember(IsRequired = true)]
			public long PayerSubTypeLookupSK { get; set; }
			...
			[DataMember]
			public String PayerSubTypeName { get; set; }

			[DataMember]
			public String PayerSubTypeDescription { get; set; }
