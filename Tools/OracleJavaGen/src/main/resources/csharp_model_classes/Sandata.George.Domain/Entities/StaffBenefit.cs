...
namespace Sandata.George.Domain.Entities
{
	...
	public class StaffBenefit
	{
			...
			public long StaffBenefitSK { get; set; }

			[DataMember(IsRequired = true)]
			public String StaffBenefitID { get; set; }
			...
			[DataMember]
			public String StaffBenefitName { get; set; }

			[DataMember]
			public String StaffBenefitDescription { get; set; }

			[IgnoreDataMember]
			public Nullable<DateTime> StaffBenefitStartDate { get; set; }

			[DataMember(Name = "StaffBenefitStartDate")]
			public string StaffBenefitStartDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(StaffBenefitStartDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						StaffBenefitStartDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}

			[IgnoreDataMember]
			public Nullable<DateTime> StaffBenefitEndDate { get; set; }

			[DataMember(Name = "StaffBenefitEndDate")]
			public string StaffBenefitEndDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(StaffBenefitEndDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						StaffBenefitEndDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}
