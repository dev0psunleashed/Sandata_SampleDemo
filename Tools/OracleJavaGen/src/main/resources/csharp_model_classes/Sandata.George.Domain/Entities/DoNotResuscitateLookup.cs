...
{
	[DataContract]
	public class DoNotResuscitateLookup
	{

			[DataMember(IsRequired = true)]
			public long DoNotResuscitateLookupSK { get; set; }
			...
			[DataMember(IsRequired = true)]
			public DoNotResuscitateName DoNotResuscitateName { get; set; }

			[DataMember]
			public String DoNotResuscitateDescription { get; set; }
