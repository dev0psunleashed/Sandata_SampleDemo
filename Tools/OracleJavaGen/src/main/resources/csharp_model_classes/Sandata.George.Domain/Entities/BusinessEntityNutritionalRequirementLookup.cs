...
{
	[DataContract]
	public class BusinessEntityNutritionalRequirementLookup
	{
			...
			public long BusinessEntityNutritionalRequirementLookupSK { get; set; }
			...
			[DataMember]
			public String NutritionalRequirementName { get; set; }

			[DataMember]
			public String NutritionalRequirementDescription { get; set; }
