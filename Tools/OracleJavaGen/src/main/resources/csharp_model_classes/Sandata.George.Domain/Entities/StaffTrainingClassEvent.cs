...
{
	[DataContract]
	public class StaffTrainingClassEvent
	{
			...
			[DataMember]
			public List<StaffTraining> StaffTrainingPropertyCollection { get; set; }

			[DataMember]
			public List<StaffTrainingClassEventAttendance> StaffTrainingClassEventAttendanceCollection { get; set; }

			[DataMember(IsRequired = true)]
			public long StaffTrainingClassEventSK { get; set; }
			...
			[DataMember]
			public long? StaffTrainingMaxAttendance { get; set; }

			[DataMember]
			public String StaffTrainingInstructorFirstName { get; set; }

			[DataMember]
			public String StaffTrainingInstructorLastName { get; set; }
