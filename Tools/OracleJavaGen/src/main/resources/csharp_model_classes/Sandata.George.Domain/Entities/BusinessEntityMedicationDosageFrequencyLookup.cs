...
{
	[DataContract]
	public class BusinessEntityMedicationDosageFrequencyLookup
	{
			...
			public long BusinessEntityMedicationDosageFrequencyLookupSK { get; set; }
			...
			[DataMember]
			public String MedicationDosageFrequencyDescription { get; set; }
