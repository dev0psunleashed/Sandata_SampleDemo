...
{
	[DataContract]
	public class StaffAdmissionType
	{

			[DataMember(IsRequired = true)]
			public long StaffAdmissionTypeSK { get; set; }

			[DataMember(IsRequired = true)]
			public String StaffAdmissionTypeID { get; set; }
			...
			[DataMember(IsRequired = true)]
			public String StaffAdmissionPayerType { get; set; }
