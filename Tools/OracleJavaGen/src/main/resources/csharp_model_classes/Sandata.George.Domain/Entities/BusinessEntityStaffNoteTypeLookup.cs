...
{
	[DataContract]
	public class BusinessEntityStaffNoteTypeLookup
	{

			[DataMember]
			public List<StaffNote> StaffNotePropertyCollection { get; set; }

			[DataMember(IsRequired = true)]
			public long BusinessEntityStaffNoteTypeLookupSK { get; set; }
			...
			[DataMember]
			public String StaffNoteTypeName { get; set; }

			[DataMember]
			public String StaffNoteTypeDescription { get; set; }
