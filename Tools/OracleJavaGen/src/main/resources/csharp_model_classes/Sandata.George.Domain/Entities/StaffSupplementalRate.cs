...
{
	[DataContract]
	public class StaffSupplementalRate
	{

			[DataMember(IsRequired = true)]
			public long StaffSupplementalRateSK { get; set; }
			...
			[IgnoreDataMember]
			public DateTime StaffSupplementalRateEffectiveDate { get; set; }

			[DataMember(Name = "StaffSupplementalRateEffectiveDate", IsRequired = true)]
			public string StaffSupplementalRateEffectiveDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(StaffSupplementalRateEffectiveDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						StaffSupplementalRateEffectiveDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}

			[IgnoreDataMember]
			public DateTime StaffSupplementalRateTerminationDate { get; set; }

			[DataMember(Name = "StaffSupplementalRateTerminationDate", IsRequired = true)]
			public string StaffSupplementalRateTerminationDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(StaffSupplementalRateTerminationDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						StaffSupplementalRateTerminationDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}

			[DataMember(IsRequired = true)]
			public RateChangeQualifier StaffSupplementalRateChangeQualifier { get; set; }
			...
			[DataMember(IsRequired = true)]
			public decimal StaffSupplementalRateProperty { get; set; }
