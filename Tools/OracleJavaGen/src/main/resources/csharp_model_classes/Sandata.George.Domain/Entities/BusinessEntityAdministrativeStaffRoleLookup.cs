...
{
	[DataContract]
	public class BusinessEntityAdministrativeStaffRoleLookup
	{
			...
			public long BusinessEntityAdministrativeStaffRoleLookupSK { get; set; }
			...
			[DataMember]
			public String AdministrativeStaffRoleDescription { get; set; }
