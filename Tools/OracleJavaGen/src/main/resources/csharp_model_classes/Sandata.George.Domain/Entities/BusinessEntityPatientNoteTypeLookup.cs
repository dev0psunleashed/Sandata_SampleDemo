...
{
	[DataContract]
	public class BusinessEntityPatientNoteTypeLookup
	{

			[DataMember]
			public List<PatientNote> PatientNotePropertyCollection { get; set; }

			[DataMember(IsRequired = true)]
			public long BusinessEntityPatientNoteTypeLookupSK { get; set; }
