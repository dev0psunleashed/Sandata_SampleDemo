...
namespace Sandata.George.Domain.Entities
{
	...
	public class Task
	{
			...
			[DataMember]
			public String BusinessEntityTaskName { get; set; }

			[DataMember]
			public String TaskDescription { get; set; }

			[DataMember]
			public bool? TaskReadingIndicator { get; set; }

			[DataMember]
			public String TaskReadingValidationRule { get; set; }

			[DataMember]
			public bool? CriticalTaskIndicator { get; set; }

			[IgnoreDataMember]
			public Nullable<DateTime> TaskEffectiveDate { get; set; }

			[DataMember(Name = "TaskEffectiveDate")]
			public string TaskEffectiveDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(TaskEffectiveDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						TaskEffectiveDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}

			[IgnoreDataMember]
			public Nullable<DateTime> TaskTerminationDate { get; set; }

			[DataMember(Name = "TaskTerminationDate")]
			public string TaskTerminationDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(TaskTerminationDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						TaskTerminationDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}
