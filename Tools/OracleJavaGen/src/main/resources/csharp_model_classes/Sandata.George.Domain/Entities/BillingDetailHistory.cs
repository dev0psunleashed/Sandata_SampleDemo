...
{
	[DataContract]
	public class BillingDetailHistory
	{

			[DataMember(IsRequired = true)]
			public long BillingDetailHistorySK { get; set; }
			...
			[DataMember]
			public String BillingDetailStatus { get; set; }

			[DataMember]
			public String BillingDetailSubmissionStatus { get; set; }
