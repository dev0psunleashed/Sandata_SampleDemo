...
{
	[DataContract]
	public class PatientSafetyMeasure
	{

			[DataMember(IsRequired = true)]
			public long PatientSafetyMeasureSK { get; set; }

			[DataMember(IsRequired = true)]
			public String PatientSafetyMeasureID { get; set; }
			...
			[DataMember]
			public String SafetyMeasureName { get; set; }

			[DataMember]
			public String SafetyMeasureDescription { get; set; }
