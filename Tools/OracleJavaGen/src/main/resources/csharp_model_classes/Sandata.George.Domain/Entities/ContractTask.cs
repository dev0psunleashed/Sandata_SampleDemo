...
namespace Sandata.George.Domain.Entities
{
	...
	public class ContractTask
	{
			...
			public long ContractTaskSK { get; set; }
			...
			[IgnoreDataMember]
			public DateTime ContractTaskEffectiveDate { get; set; }

			[DataMember(Name = "ContractTaskEffectiveDate", IsRequired = true)]
			public string ContractTaskEffectiveDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(ContractTaskEffectiveDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						ContractTaskEffectiveDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}

			[IgnoreDataMember]
			public Nullable<DateTime> ContractTaskTerminationDate { get; set; }

			[DataMember(Name = "ContractTaskTerminationDate")]
			public string ContractTaskTerminationDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(ContractTaskTerminationDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						ContractTaskTerminationDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}

			[DataMember]
			public bool? NoTaskRequiredIndicator { get; set; }
