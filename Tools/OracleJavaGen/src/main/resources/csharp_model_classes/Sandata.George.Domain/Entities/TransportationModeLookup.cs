...
{
	[DataContract]
	public class TransportationModeLookup
	{

			[DataMember(IsRequired = true)]
			public long TransportationModeLookupSK { get; set; }
			...
			[DataMember]
			public TransportationModeName TransportationModeName { get; set; }

			[DataMember]
			public String TransportationModeDescription { get; set; }
