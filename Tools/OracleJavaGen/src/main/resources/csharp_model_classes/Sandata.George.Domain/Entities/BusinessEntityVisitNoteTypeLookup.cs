...
{
	[DataContract]
	public class BusinessEntityVisitNoteTypeLookup
	{

			[DataMember]
			public List<VisitNote> VisitNotePropertyCollection { get; set; }

			[DataMember(IsRequired = true)]
			public long BusinessEntityVisitNoteTypeLookupSK { get; set; }
			...
			[DataMember(IsRequired = true)]
			public String VisitNoteTypeName { get; set; }

			[DataMember]
			public String VisitNoteTypeDescription { get; set; }
