...
{
	[DataContract]
	public class PayerRateModifier
	{

			[DataMember(IsRequired = true)]
			public long PayerRateModifierSK { get; set; }
			...
			[DataMember(IsRequired = true)]
			public String PayerRateModifierCode { get; set; }

			[DataMember]
			public String PayerRateModifierDescription { get; set; }
