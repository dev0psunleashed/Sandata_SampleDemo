...
{
	[DataContract]
	public class HCPCSLookup
	{

			[DataMember(IsRequired = true)]
			public long HCPCSLookupSK { get; set; }
			...
			[DataMember]
			public String HCPCSShortDescription { get; set; }

			[DataMember]
			public String HCPCSLongDescription { get; set; }

			[DataMember]
			public long? HCPCSCodeVersion { get; set; }
