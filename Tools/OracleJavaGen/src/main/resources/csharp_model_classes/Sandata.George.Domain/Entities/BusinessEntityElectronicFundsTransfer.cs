...
{
	[DataContract]
	public class BusinessEntityElectronicFundsTransfer
	{

			[DataMember(IsRequired = true)]
			public long BusinessEntityElectronicFundsTransferSK { get; set; }

			[DataMember(IsRequired = true)]
			public String BusinessEntityElectronicFundsTransferID { get; set; }
			...
			[DataMember]
			public String ElectronicFundsTransferNumber { get; set; }

			[IgnoreDataMember]
			public Nullable<DateTime> ElectronicFundsTransferIssueTimestamp { get; set; }

			[DataMember(Name = "ElectronicFundsTransferIssueTimestamp")]
			public string ElectronicFundsTransferIssueTimestampStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(ElectronicFundsTransferIssueTimestamp);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						ElectronicFundsTransferIssueTimestamp = DateTimeHelper.ToDateTime(value);
					}
				}
			}
