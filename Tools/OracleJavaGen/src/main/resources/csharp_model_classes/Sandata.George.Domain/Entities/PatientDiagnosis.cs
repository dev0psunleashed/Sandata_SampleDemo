...
namespace Sandata.George.Domain.Entities
{
	...
	public class PatientDiagnosis
	{
			...
			public long PatientDiagnosisSK { get; set; }
			...
			[IgnoreDataMember]
			public DateTime PatientDiagnosisEffectiveDate { get; set; }

			[DataMember(Name = "PatientDiagnosisEffectiveDate", IsRequired = true)]
			public string PatientDiagnosisEffectiveDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(PatientDiagnosisEffectiveDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						PatientDiagnosisEffectiveDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}

			[IgnoreDataMember]
			public Nullable<DateTime> PatientDiagnosisTerminationDate { get; set; }

			[DataMember(Name = "PatientDiagnosisTerminationDate")]
			public string PatientDiagnosisTerminationDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(PatientDiagnosisTerminationDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						PatientDiagnosisTerminationDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}
