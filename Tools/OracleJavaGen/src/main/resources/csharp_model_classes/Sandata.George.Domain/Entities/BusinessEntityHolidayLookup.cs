...
{
	[DataContract]
	public class BusinessEntityHolidayLookup
	{

			[DataMember(IsRequired = true)]
			public long BusinessEntityHolidayLookupSK { get; set; }
			...
			[DataMember(Name = "HolidayStartDatetime", IsRequired = true)]
			public string HolidayStartDatetimeStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(HolidayStartDatetime);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						HolidayStartDatetime = DateTimeHelper.ToDateTime(value);
					}
				}
			}
			...
			[DataMember(Name = "HolidayEndDatetime", IsRequired = true)]
			public string HolidayEndDatetimeStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(HolidayEndDatetime);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						HolidayEndDatetime = DateTimeHelper.ToDateTime(value);
					}
				}
			}

			[DataMember]
			public bool? HolidayFullDayIndicator { get; set; }

			[DataMember]
			public bool? HolidayBillIndicator { get; set; }

			[DataMember]
			public bool? HolidayPayIndicator { get; set; }
