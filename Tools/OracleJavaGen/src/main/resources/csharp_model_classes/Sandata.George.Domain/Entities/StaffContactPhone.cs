...
{
	[DataContract]
	public class StaffContactPhone
	{

			[DataMember(IsRequired = true)]
			public long StaffContactPhoneSK { get; set; }
			...
			[DataMember]
			public String StaffContactPhoneQualifier { get; set; }

			[DataMember]
			public String StaffPhone { get; set; }

			[DataMember]
			public String StaffPhoneExtension { get; set; }

			[DataMember]
			public bool? StaffPhonePrimaryIndicator { get; set; }

			[DataMember]
			public bool? StaffPhoneTextMessageIndicator { get; set; }
