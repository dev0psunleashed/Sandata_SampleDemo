...
namespace Sandata.George.Domain.Entities
{
	...
	public class BusinessEntityRelationship
	{
			...
			public long BusinessEntityRelationshipSK { get; set; }

			[DataMember(IsRequired = true)]
			public String BusinessEntityRelationshipID { get; set; }
			...
			[DataMember]
			public String BusinessEntityParentID { get; set; }

			[DataMember(IsRequired = true)]
			public long BusinessEntityLevelSK { get; set; }

			[DataMember]
			public String BusinessEntityRelationshipType { get; set; }

			[DataMember]
			public String BusinessEntityRelationshipStatus { get; set; }
