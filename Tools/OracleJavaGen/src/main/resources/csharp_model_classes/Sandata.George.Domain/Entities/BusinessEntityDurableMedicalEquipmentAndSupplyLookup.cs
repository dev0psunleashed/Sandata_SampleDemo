...
{
	[DataContract]
	public class BusinessEntityDurableMedicalEquipmentAndSupplyLookup
	{
			...
			public long BusinessEntityDurableMedicalEquipmentAndSupplyLookupSK { get; set; }
			...
			[DataMember(IsRequired = true)]
			public String DurableMedicalEquipmentSupplyID { get; set; }

			[DataMember]
			public String DurableMedicalEquipmentSupplyType { get; set; }

			[DataMember]
			public String DurableMedicalEquipmentSupplyName { get; set; }

			[DataMember]
			public String DurableMedicalEquipmentSupplyDescription { get; set; }
