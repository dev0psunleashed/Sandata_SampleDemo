...
{
	[DataContract]
	public class BusinessEntityMedicationDosageStrengthLookup
	{
			...
			public long BusinessEntityMedicationDosageStrengthLookupSK { get; set; }
			...
			[DataMember]
			public String MedicationDosageStrengthDescription { get; set; }
