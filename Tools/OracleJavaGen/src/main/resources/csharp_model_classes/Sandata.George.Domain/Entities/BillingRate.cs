...
namespace Sandata.George.Domain.Entities
{
	...
	public class BillingRate
	{
			...
			public long BillingRateSK { get; set; }

			[DataMember(IsRequired = true)]
			public String BillingRateID { get; set; }
			...
			[DataMember]
			public String PatientBillingRateUnit { get; set; }

			[DataMember]
			public decimal? PatientBusinessEntityHourlyRate { get; set; }

			[DataMember]
			public decimal? PatientPayerBillRate { get; set; }
