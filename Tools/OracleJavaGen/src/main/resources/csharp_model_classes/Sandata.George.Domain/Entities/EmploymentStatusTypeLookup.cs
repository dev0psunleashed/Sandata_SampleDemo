...
{
	[DataContract]
	public class EmploymentStatusTypeLookup
	{
			...
			public long EmploymentStatusTypeLookupSK { get; set; }
			...
			[DataMember]
			public EmploymentStatusTypeName EmploymentStatusTypeName { get; set; }

			[DataMember]
			public String EmploymentStatusTypeDescription { get; set; }
