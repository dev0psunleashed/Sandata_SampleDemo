...
namespace Sandata.George.Domain.Entities
{
	...
	public class StaffCertification
	{
			...
			public long StaffCertificationSK { get; set; }
			...
			[DataMember]
			public String StaffCertificationID { get; set; }

			[DataMember]
			public String StaffCertificationName { get; set; }

			[DataMember]
			public String StaffCertificationDescription { get; set; }

			[DataMember]
			public String StaffCertificationInstitution { get; set; }

			[IgnoreDataMember]
			public Nullable<DateTime> StaffCertificationReceivedDate { get; set; }

			[DataMember(Name = "StaffCertificationReceivedDate")]
			public string StaffCertificationReceivedDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(StaffCertificationReceivedDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						StaffCertificationReceivedDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}

			[IgnoreDataMember]
			public Nullable<DateTime> StaffCertificationExpirationDate { get; set; }

			[DataMember(Name = "StaffCertificationExpirationDate")]
			public string StaffCertificationExpirationDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(StaffCertificationExpirationDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						StaffCertificationExpirationDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}
