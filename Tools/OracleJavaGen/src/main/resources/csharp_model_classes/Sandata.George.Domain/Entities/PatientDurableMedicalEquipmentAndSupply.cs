...
{
	[DataContract]
	public class PatientDurableMedicalEquipmentAndSupply
	{

			[DataMember(IsRequired = true)]
			public long PatientDurableMedicalEquipmentAndSupplySK { get; set; }
			...
			[DataMember]
			public String PatientDurableMedicalEquipmentSupplyName { get; set; }
