...
{
	[DataContract]
	public class InvoiceSubmissionTypeLookup
	{

			[DataMember]
			public List<Invoice> InvoicePropertyCollection { get; set; }
			...
			public long InvoiceSubmissionTypeLookupSK { get; set; }
			...
			[DataMember]
			public String InvoiceSubmissionTypeDescription { get; set; }
