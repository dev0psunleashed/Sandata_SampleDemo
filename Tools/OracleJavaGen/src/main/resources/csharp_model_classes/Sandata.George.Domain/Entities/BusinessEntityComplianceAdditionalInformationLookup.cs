...
{
	[DataContract]
	public class BusinessEntityComplianceAdditionalInformationLookup
	{
			...
			public long BusinessEntityComplianceAdditionalInformationLookupSK { get; set; }
			...
			[DataMember]
			public String ComplainceAdditionalInformationTypeName { get; set; }

			[DataMember]
			public String ComplianceAdditionalInformationName { get; set; }

			[DataMember]
			public String ComplianceAdditionalInformationDescription { get; set; }

			[DataMember]
			public String ComplianceAdditionalInformationNote { get; set; }
