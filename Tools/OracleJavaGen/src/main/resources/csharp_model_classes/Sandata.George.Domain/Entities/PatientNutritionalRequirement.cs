...
{
	[DataContract]
	public class PatientNutritionalRequirement
	{

			[DataMember(IsRequired = true)]
			public long PatientNutritionalRequirementSK { get; set; }

			[DataMember(IsRequired = true)]
			public String PatientNutritionalRequirementID { get; set; }
			...
			[DataMember]
			public String PatientNutritionalName { get; set; }
