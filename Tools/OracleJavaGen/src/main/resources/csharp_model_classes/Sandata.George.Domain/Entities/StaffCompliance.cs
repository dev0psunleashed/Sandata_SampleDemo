...
namespace Sandata.George.Domain.Entities
{
	...
	public class StaffCompliance
	{
			...
			public long StaffComplianceSK { get; set; }
			...
			[DataMember]
			public String ComplianceReadingValue { get; set; }

			[IgnoreDataMember]
			public Nullable<DateTime> StaffComplianceReceivedDate { get; set; }

			[DataMember(Name = "StaffComplianceReceivedDate")]
			public string StaffComplianceReceivedDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(StaffComplianceReceivedDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						StaffComplianceReceivedDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}

			[IgnoreDataMember]
			public Nullable<DateTime> StaffComplianceExpirationDate { get; set; }

			[DataMember(Name = "StaffComplianceExpirationDate")]
			public string StaffComplianceExpirationDateStr
			{
				get
				{
					return DateTimeHelper.ToDateTimeString(StaffComplianceExpirationDate);
				}
				set
				{
					if (!String.IsNullOrEmpty(value))
					{
						StaffComplianceExpirationDate = DateTimeHelper.ToDateTime(value);
					}
				}
			}

			[DataMember]
			public String StaffComplianceNote { get; set; }
