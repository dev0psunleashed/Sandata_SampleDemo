...
{
	[DataContract]
	public class InterfaceItemLookup
	{
			...
			public long InterfaceItemLookupSK { get; set; }
			...
			[DataMember]
			public InterfaceItemTypeQualifier InterfaceItemTypeQualifier { get; set; }

			[DataMember]
			public String InterfaceItemDescription { get; set; }

			[DataMember]
			public String InterfaceItemDefinition { get; set; }

			[DataMember]
			public String InterfaceItemValidationRule { get; set; }
