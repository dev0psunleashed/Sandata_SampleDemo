...
{
	[DataContract]
	public class BusinessEntityPayrollCodeLookup
	{
			...
			public long BusinessEntityPayrollCodeLookupSK { get; set; }
			...
			[DataMember(IsRequired = true)]
			public String PayrollCodeProperty { get; set; }

			[DataMember(IsRequired = true)]
			public PayrollCodeQualifier PayrollCodeQualifier { get; set; }

			[DataMember(IsRequired = true)]
			public PayrollCodeTypeName PayrollCodeTypeName { get; set; }
