...
{
	[DataContract]
	public class StaffTrainingLocation
	{
			...
			public long StaffTrainingLocationSK { get; set; }
			...
			[DataMember]
			public String StaffTrainingAddressLine1 { get; set; }

			[DataMember]
			public String StaffTrainingAddressLine2 { get; set; }

			[DataMember]
			public String StaffTrainingCity { get; set; }

			[DataMember]
			public StateCode StaffTrainingState { get; set; }

			[DataMember]
			public String StaffTrainingPostalCode { get; set; }

			[DataMember]
			public String StaffTrainingZip4 { get; set; }
