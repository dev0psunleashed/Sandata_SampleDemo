...
public class StaffTrngClsEvntAttndT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "COREDATA.STAFF_TRNG_CLS_EVNT_ATTND_T";
  public static final int _SQL_TYPECODE = OracleTypes.STRUCT;

  protected MutableStruct _struct;

  protected static int[] _sqlType =  { 2,91,91,91,91,12,12,12,2,2,12,12,12,91,12,12 };
  protected static ORADataFactory[] _factory = new ORADataFactory[16];
  protected static final StaffTrngClsEvntAttndT _StaffTrngClsEvntAttndTFactory = new StaffTrngClsEvntAttndT();

  public static ORADataFactory getORADataFactory()
  { return _StaffTrngClsEvntAttndTFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[16], _sqlType, _factory); }
  public StaffTrngClsEvntAttndT()
  { _init_struct(true); }
  public StaffTrngClsEvntAttndT(java.math.BigDecimal staffTrngClsEvntAttndSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, java.sql.Timestamp recEffTmstp, java.sql.Timestamp recTermTmstp, String recCreatedBy, String recUpdatedBy, String changeReasonMemo, java.math.BigDecimal currRecInd, java.math.BigDecimal changeVersionId, String beId, String staffTrngLocName, String staffTrngCode, java.sql.Timestamp staffTrngStartDtime, String staffTrngQlfr, String staffId) throws SQLException
  { _init_struct(true);
    setStaffTrngClsEvntAttndSk(staffTrngClsEvntAttndSk);
  ...
  protected ORAData create(StaffTrngClsEvntAttndT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new StaffTrngClsEvntAttndT();
    o._struct = new MutableStruct((STRUCT) d, _sqlType, _factory);
    return o;
  }
  /* accessor methods */
  public java.math.BigDecimal getStaffTrngClsEvntAttndSk() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(0); }

  public void setStaffTrngClsEvntAttndSk(java.math.BigDecimal staffTrngClsEvntAttndSk) throws SQLException
  { _struct.setAttribute(0, staffTrngClsEvntAttndSk); }
  ...
  { _struct.setAttribute(14, staffTrngQlfr); }
  ...
  { _struct.setAttribute(15, staffId); }
