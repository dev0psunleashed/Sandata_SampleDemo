...
@XmlType(name = "Contact_Method_Lookup", propOrder = {
    "staffNotificationMethod"
})
@OracleMetadata(
        packageName = "PKG_LOOKUP",
        insertMethod = "insertContMthdLkup",
        updateMethod = "updateContMthdLkup",
        deleteMethod = "deleteContMthdLkup",
        getMethod = "getContMthdLkup",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.ContMthdLkupT",
        primaryKeys = {})
public class ContactMethodLookup extends BaseObject {
    ...
    @XmlAttribute(name = "Contact_Method_Lookup_SK", required = true)
    @SerializedName("ContactMethodLookupSK")
	@Mapping(getter = "getContMthdLkupSk", setter = "setContMthdLkupSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger contactMethodLookupSK;
    ...
    @XmlAttribute(name = "Contact_Method_Name", required = true)
    @SerializedName("ContactMethodName")
	@Mapping(getter = "getContMthdName", setter = "setContMthdName", type = "String", index = 10)
    protected String contactMethodName;
    @XmlAttribute(name = "Contact_Method_Description")
    @SerializedName("ContactMethodDescription")
	@Mapping(getter = "getContMthdDesc", setter = "setContMthdDesc", type = "String", index = 11)
    ...
    /**
     * Gets the value of the contactMethodLookupSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getContactMethodLookupSK() {
        return contactMethodLookupSK;
    }

    /**
     * Sets the value of the contactMethodLookupSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setContactMethodLookupSK(BigInteger value) {
        this.contactMethodLookupSK = value;
    }
    ...
    /**
     * Gets the value of the contactMethodName property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the contactMethodName property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setContactMethodName(String value) {
        this.contactMethodName = value;
    }
