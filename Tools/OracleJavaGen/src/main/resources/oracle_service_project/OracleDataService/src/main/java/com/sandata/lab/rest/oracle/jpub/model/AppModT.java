...
public class AppModT implements ORAData, ORADataFactory
{
  ...
  public AppModT()
  { _init_struct(true); }
  public AppModT(java.math.BigDecimal appModSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, java.math.BigDecimal appModParSk, String modName, String modTypName) throws SQLException
  { _init_struct(true);
