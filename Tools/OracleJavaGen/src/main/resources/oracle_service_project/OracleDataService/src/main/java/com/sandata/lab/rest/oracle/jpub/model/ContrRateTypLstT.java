...
public class ContrRateTypLstT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "COREDATA.CONTR_RATE_TYP_LST_T";
  ...
  protected static final ContrRateTypLstT _ContrRateTypLstTFactory = new ContrRateTypLstT();

  public static ORADataFactory getORADataFactory()
  { return _ContrRateTypLstTFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[15], _sqlType, _factory); }
  public ContrRateTypLstT()
  { _init_struct(true); }
  public ContrRateTypLstT(java.math.BigDecimal contrRateTypLstSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, java.sql.Timestamp recEffTmstp, java.sql.Timestamp recTermTmstp, String recCreatedBy, String recUpdatedBy, String changeReasonMemo, java.math.BigDecimal currRecInd, java.math.BigDecimal changeVersionId, String beId, String payerId, String contrId, String rateTypName, String rateQlfrCode) throws SQLException
  { _init_struct(true);
    setContrRateTypLstSk(contrRateTypLstSk);
  ...
  protected ORAData create(ContrRateTypLstT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new ContrRateTypLstT();
    o._struct = new MutableStruct((STRUCT) d, _sqlType, _factory);
    return o;
  }
  /* accessor methods */
  public java.math.BigDecimal getContrRateTypLstSk() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(0); }

  public void setContrRateTypLstSk(java.math.BigDecimal contrRateTypLstSk) throws SQLException
  { _struct.setAttribute(0, contrRateTypLstSk); }
