 ...
 * 
 * <p>Java class for Business_Entity_Safety_Measure_Lookup complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Business_Entity_Safety_Measure_Lookup">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;attribute name="Business_Entity_Safety_Measure_Lookup_SK" use="required" type="{}Surrogate_Key" />
 ...
 *       &lt;attribute name="Safety_Measure_ID" use="required" type="{}ID" />
...
@XmlType(name = "Business_Entity_Safety_Measure_Lookup")
@OracleMetadata(
        packageName = "PKG_AM",
        insertMethod = "insertBeSftyMeasureLkup",
        updateMethod = "updateBeSftyMeasureLkup",
        deleteMethod = "deleteBeSftyMeasureLkup",
        getMethod = "getBeSftyMeasureLkup",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.BeSftyMeasureLkupT",
        primaryKeys = {})
public class BusinessEntitySafetyMeasureLookup extends BaseObject {

	private static final long serialVersionUID = 1L;

    @XmlAttribute(name = "Business_Entity_Safety_Measure_Lookup_SK", required = true)
    @SerializedName("BusinessEntitySafetyMeasureLookupSK")
	@Mapping(getter = "getBeSftyMeasureLkupSk", setter = "setBeSftyMeasureLkupSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger businessEntitySafetyMeasureLookupSK;
    ...
    @XmlAttribute(name = "Safety_Measure_ID", required = true)
    @SerializedName("SafetyMeasureID")
	@Mapping(getter = "getSftyMeasureId", setter = "setSftyMeasureId", type = "String", index = 11)
    protected String safetyMeasureID;
    @XmlAttribute(name = "Safety_Measure_Name")
    @SerializedName("SafetyMeasureName")
	@Mapping(getter = "getSftyMeasureName", setter = "setSftyMeasureName", type = "String", index = 12)
    protected String safetyMeasureName;
    @XmlAttribute(name = "Safety_Measure_Description")
    @SerializedName("SafetyMeasureDescription")
	@Mapping(getter = "getSftyMeasureDesc", setter = "setSftyMeasureDesc", type = "String", index = 13)
    protected String safetyMeasureDescription;

    /**
     * Gets the value of the businessEntitySafetyMeasureLookupSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getBusinessEntitySafetyMeasureLookupSK() {
        return businessEntitySafetyMeasureLookupSK;
    }

    /**
     * Sets the value of the businessEntitySafetyMeasureLookupSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setBusinessEntitySafetyMeasureLookupSK(BigInteger value) {
        this.businessEntitySafetyMeasureLookupSK = value;
    }
    ...
    /**
     * Gets the value of the safetyMeasureID property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the safetyMeasureID property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSafetyMeasureID(String value) {
        this.safetyMeasureID = value;
    }
