...
/**
 * Establishes a relationship between two different Staff.  Used to support multiple Staff hierarchies within a single Business Entity.
 * 
 * <p>Java class for Administrative_Staff_Relationship complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Administrative_Staff_Relationship">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;attribute name="Administrative_Staff_Relationship_SK" use="required" type="{}Surrogate_Key" />
 ...
 *       &lt;attribute name="Administrative_Staff_Parent_ID" type="{}ID" />
 *       &lt;attribute name="Administrative_Staff_Relationship_Effective_Date" use="required" type="{}Attribute_Effective_Date" />
 *       &lt;attribute name="Administrative_Staff_Relationship_Termination_Date" use="required" type="{}Attribute_Termination_Date" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "Administrative_Staff_Relationship")
@OracleMetadata(
        packageName = "PKG_ADMIN",
        insertMethod = "insertAdminStaffRel",
        updateMethod = "updateAdminStaffRel",
        deleteMethod = "deleteAdminStaffRel",
        getMethod = "getAdminStaffRel",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.AdminStaffRelT",
        primaryKeys = {})
public class AdministrativeStaffRelationship extends BaseObject {

	private static final long serialVersionUID = 1L;

    @XmlAttribute(name = "Administrative_Staff_Relationship_SK", required = true)
    @SerializedName("AdministrativeStaffRelationshipSK")
	@Mapping(getter = "getAdminStaffRelSk", setter = "setAdminStaffRelSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger administrativeStaffRelationshipSK;
    ...
    @XmlAttribute(name = "Administrative_Staff_Parent_ID")
    @SerializedName("AdministrativeStaffParentID")
	@Mapping(getter = "getAdminStaffParId", setter = "setAdminStaffParId", type = "String", index = 12)
    protected String administrativeStaffParentID;
    @XmlAttribute(name = "Administrative_Staff_Relationship_Effective_Date", required = true)
    @SerializedName("AdministrativeStaffRelationshipEffectiveDate")
    @XmlJavaTypeAdapter(Adapter1 .class)
	@Mapping(getter = "getAdminStaffRelEffDate", setter = "setAdminStaffRelEffDate", type = "java.sql.Timestamp", index = 13)
    protected Date administrativeStaffRelationshipEffectiveDate;
    @XmlAttribute(name = "Administrative_Staff_Relationship_Termination_Date", required = true)
    @SerializedName("AdministrativeStaffRelationshipTerminationDate")
    @XmlJavaTypeAdapter(Adapter1 .class)
	@Mapping(getter = "getAdminStaffRelTermDate", setter = "setAdminStaffRelTermDate", type = "java.sql.Timestamp", index = 14)
    protected Date administrativeStaffRelationshipTerminationDate;

    /**
     * Gets the value of the administrativeStaffRelationshipSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
    ...
    /**
     * Sets the value of the administrativeStaffRelationshipSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setAdministrativeStaffRelationshipSK(BigInteger value) {
        this.administrativeStaffRelationshipSK = value;
    }
    ...
    /**
     * Gets the value of the administrativeStaffParentID property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getAdministrativeStaffParentID() {
        return administrativeStaffParentID;
    }

    /**
     * Sets the value of the administrativeStaffParentID property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setAdministrativeStaffParentID(String value) {
        this.administrativeStaffParentID = value;
    }

    /**
     * Gets the value of the administrativeStaffRelationshipEffectiveDate property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public Date getAdministrativeStaffRelationshipEffectiveDate() {
        return administrativeStaffRelationshipEffectiveDate;
    }

    /**
     * Sets the value of the administrativeStaffRelationshipEffectiveDate property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setAdministrativeStaffRelationshipEffectiveDate(Date value) {
        this.administrativeStaffRelationshipEffectiveDate = value;
    }

    /**
     * Gets the value of the administrativeStaffRelationshipTerminationDate property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public Date getAdministrativeStaffRelationshipTerminationDate() {
        return administrativeStaffRelationshipTerminationDate;
    }

    /**
     * Sets the value of the administrativeStaffRelationshipTerminationDate property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setAdministrativeStaffRelationshipTerminationDate(Date value) {
        this.administrativeStaffRelationshipTerminationDate = value;
    }
