...
@XmlType(name = "County_Lookup", propOrder = {
...
@OracleMetadata(
        ...
        insertMethod = "insertCountyLkup",
        updateMethod = "updateCountyLkup",
        deleteMethod = "deleteCountyLkup",
        getMethod = "getCountyLkup",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.CountyLkupT",
        primaryKeys = {})
public class CountyLookup extends BaseObject {
    ...
    @XmlElement(name = "Postal_Code_Lookup")
    @SerializedName("PostalCodeLookup")
    protected List<PostalCodeLookup> postalCodeLookup;
    @XmlAttribute(name = "County_Lookup_SK", required = true)
    @SerializedName("CountyLookupSK")
	@Mapping(getter = "getCountyLkupSk", setter = "setCountyLkupSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger countyLookupSK;
    ...
    @XmlAttribute(name = "County_Federal_Information_Processing_Standard_Code", required = true)
    @SerializedName("CountyFederalInformationProcessingStandardCode")
	@Mapping(getter = "getCountyFipsCode", setter = "setCountyFipsCode", type = "String", index = 10)
    protected String countyFederalInformationProcessingStandardCode;
    @XmlAttribute(name = "County_Name", required = true)
    @SerializedName("CountyName")
	@Mapping(getter = "getCountyName", setter = "setCountyName", type = "String", index = 11)
	...
	@Mapping(getter = "getStateCode", setter = "setStateCode", type = "String", index = 13)
    protected StateCode stateCode;
    @XmlAttribute(name = "Federal_Information_Processing_Standard_Class_Code")
    @SerializedName("FederalInformationProcessingStandardClassCode")
	@Mapping(getter = "getFipsClsCode", setter = "setFipsClsCode", type = "String", index = 14)
    protected String federalInformationProcessingStandardClassCode;
    ...
    /**
     * Gets the value of the postalCodeLookup property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the postalCodeLookup property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPostalCodeLookup().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PostalCodeLookup }
     * 
     * 
     */
    public List<PostalCodeLookup> getPostalCodeLookup() {
        if (postalCodeLookup == null) {
            postalCodeLookup = new ArrayList<PostalCodeLookup>();
        }
        return this.postalCodeLookup;
    }

    /**
     * Gets the value of the countyLookupSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getCountyLookupSK() {
        return countyLookupSK;
    }

    /**
     * Sets the value of the countyLookupSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setCountyLookupSK(BigInteger value) {
        this.countyLookupSK = value;
    }
    ...
    /**
     * Gets the value of the federalInformationProcessingStandardClassCode property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getFederalInformationProcessingStandardClassCode() {
        return federalInformationProcessingStandardClassCode;
    }

    /**
     * Sets the value of the federalInformationProcessingStandardClassCode property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setFederalInformationProcessingStandardClassCode(String value) {
        this.federalInformationProcessingStandardClassCode = value;
    }
