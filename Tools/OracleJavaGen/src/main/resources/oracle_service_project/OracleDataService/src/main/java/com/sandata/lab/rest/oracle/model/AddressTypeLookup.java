 ...
 * 
 * <p>Java class for Address_Type_Lookup complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Address_Type_Lookup">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;attribute name="Address_Type_Lookup_SK" use="required" type="{}Surrogate_Key" />
 ...
 *       &lt;attribute name="Address_Type_Name" use="required" type="{}Address_Type_Name" />
 *       &lt;attribute name="Address_Type_Description" type="{}Description_Short" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "Address_Type_Lookup")
@OracleMetadata(
        packageName = "PKG_LOOKUP",
        insertMethod = "insertAddrTypLkup",
        updateMethod = "updateAddrTypLkup",
        deleteMethod = "deleteAddrTypLkup",
        getMethod = "getAddrTypLkup",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.AddrTypLkupT",
        primaryKeys = {})
public class AddressTypeLookup extends BaseObject {

	private static final long serialVersionUID = 1L;

    @XmlAttribute(name = "Address_Type_Lookup_SK", required = true)
    @SerializedName("AddressTypeLookupSK")
	@Mapping(getter = "getAddrTypLkupSk", setter = "setAddrTypLkupSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger addressTypeLookupSK;
    ...
    @XmlAttribute(name = "Address_Type_Name", required = true)
    @SerializedName("AddressTypeName")
	@Mapping(getter = "getAddrTypName", setter = "setAddrTypName", type = "String", index = 10)
    protected AddressTypeName addressTypeName;
    @XmlAttribute(name = "Address_Type_Description")
    @SerializedName("AddressTypeDescription")
	@Mapping(getter = "getAddrTypDesc", setter = "setAddrTypDesc", type = "String", index = 11)
    protected String addressTypeDescription;

    /**
     * Gets the value of the addressTypeLookupSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getAddressTypeLookupSK() {
        return addressTypeLookupSK;
    }

    /**
     * Sets the value of the addressTypeLookupSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setAddressTypeLookupSK(BigInteger value) {
        this.addressTypeLookupSK = value;
    }
     ...
     *     
     */
    public AddressTypeName getAddressTypeName() {
     ...
     *     
     */
    public void setAddressTypeName(AddressTypeName value) {
