...
public class PrepaidCapitationPlanLookup extends BaseObject {
    ...
    @XmlAttribute(name = "Prepaid_Capitation_Plan_Lookup_SK", required = true)
    @SerializedName("PrepaidCapitationPlanLookupSK")
	@Mapping(getter = "getPcpLkupSk", setter = "setPcpLkupSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger prepaidCapitationPlanLookupSK;
    ...
    /**
     * Gets the value of the prepaidCapitationPlanLookupSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getPrepaidCapitationPlanLookupSK() {
        return prepaidCapitationPlanLookupSK;
    }

    /**
     * Sets the value of the prepaidCapitationPlanLookupSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setPrepaidCapitationPlanLookupSK(BigInteger value) {
        this.prepaidCapitationPlanLookupSK = value;
    }
