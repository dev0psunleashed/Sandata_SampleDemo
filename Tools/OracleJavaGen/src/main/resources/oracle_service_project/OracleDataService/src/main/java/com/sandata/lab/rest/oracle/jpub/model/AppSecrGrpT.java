...
public class AppSecrGrpT implements ORAData, ORADataFactory
{
  ...
  public AppSecrGrpT()
  { _init_struct(true); }
  public AppSecrGrpT(java.math.BigDecimal appSecrGrpSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, String secrGrpName) throws SQLException
  { _init_struct(true);
