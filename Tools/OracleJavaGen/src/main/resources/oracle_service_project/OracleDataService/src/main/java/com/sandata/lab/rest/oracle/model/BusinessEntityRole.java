...
/**
 * Stores the unique list of roles that can be assigned to the employees of a specific Business Entity.
 * Business Entity Roles including Caregivers, Clinical  Coordinators, Marketers, Secretaries, etal
 * 
 * <p>Java class for Business_Entity_Role complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Business_Entity_Role">
 *   &lt;complexContent>
 ...
 *       &lt;attribute name="Business_Entity_Role_ID" use="required" type="{}ID" />
 ...
 *       &lt;attribute name="Business_Entity_Role_Name" type="{}Name_Generic" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "Business_Entity_Role", propOrder = {
    "businessEntityStaffRole"
})
@OracleMetadata(
        packageName = "PKG_BSN",
        insertMethod = "insertBeRole",
        updateMethod = "updateBeRole",
        deleteMethod = "deleteBeRole",
        getMethod = "getBeRole",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.BeRoleT",
        primaryKeys = {})
public class BusinessEntityRole extends BaseObject {
	...
	@Mapping(getter = "getBeRoleSk", setter = "setBeRoleSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger businessEntityRoleSK;
    @XmlAttribute(name = "Business_Entity_Role_ID", required = true)
    @SerializedName("BusinessEntityRoleID")
	@Mapping(getter = "getBeRoleId", setter = "setBeRoleId", type = "String", index = 1)
    protected String businessEntityRoleID;
    ...
    @XmlAttribute(name = "Business_Entity_Role_Name")
    @SerializedName("BusinessEntityRoleName")
	@Mapping(getter = "getBeRoleName", setter = "setBeRoleName", type = "String", index = 12)
    protected String businessEntityRoleName;
    ...
    /**
     * Gets the value of the businessEntityRoleID property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getBusinessEntityRoleID() {
        return businessEntityRoleID;
    }

    /**
     * Sets the value of the businessEntityRoleID property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setBusinessEntityRoleID(String value) {
        this.businessEntityRoleID = value;
    }
    ...
    /**
     * Gets the value of the businessEntityRoleName property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getBusinessEntityRoleName() {
        return businessEntityRoleName;
    }

    /**
     * Sets the value of the businessEntityRoleName property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setBusinessEntityRoleName(String value) {
        this.businessEntityRoleName = value;
    }
