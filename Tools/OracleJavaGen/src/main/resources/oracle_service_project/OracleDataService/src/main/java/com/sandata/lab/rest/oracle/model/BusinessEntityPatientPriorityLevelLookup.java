...
@XmlType(name = "Business_Entity_Patient_Priority_Level_Lookup", propOrder = {
    "patient"
})
@OracleMetadata(
        packageName = "PKG_AM",
        insertMethod = "insertBePtPrioLvlLkup",
        updateMethod = "updateBePtPrioLvlLkup",
        deleteMethod = "deleteBePtPrioLvlLkup",
        getMethod = "getBePtPrioLvlLkup",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.BePtPrioLvlLkupT",
        primaryKeys = {})
public class BusinessEntityPatientPriorityLevelLookup extends BaseObject {
    ...
    @XmlAttribute(name = "Business_Entity_Patient_Priority_Level_Lookup_SK", required = true)
    @SerializedName("BusinessEntityPatientPriorityLevelLookupSK")
	@Mapping(getter = "getBePtPrioLvlLkupSk", setter = "setBePtPrioLvlLkupSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger businessEntityPatientPriorityLevelLookupSK;
	...
	@Mapping(getter = "getPtPrioLvlCode", setter = "setPtPrioLvlCode", type = "String", index = 11)
	...
	@Mapping(getter = "getPtPrioLvlName", setter = "setPtPrioLvlName", type = "String", index = 12)
	...
	@Mapping(getter = "getPtPrioLvlDesc", setter = "setPtPrioLvlDesc", type = "String", index = 13)
    ...
    /**
     * Gets the value of the businessEntityPatientPriorityLevelLookupSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getBusinessEntityPatientPriorityLevelLookupSK() {
        return businessEntityPatientPriorityLevelLookupSK;
    }

    /**
     * Sets the value of the businessEntityPatientPriorityLevelLookupSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setBusinessEntityPatientPriorityLevelLookupSK(BigInteger value) {
        this.businessEntityPatientPriorityLevelLookupSK = value;
    }
