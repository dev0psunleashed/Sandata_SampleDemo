...
@XmlType(name = "Business_Entity_Medication_Route_Lookup", propOrder = {
    "patientMedication"
})
@OracleMetadata(
        packageName = "PKG_AM",
        insertMethod = "insertBeMedRouteLkup",
        updateMethod = "updateBeMedRouteLkup",
        deleteMethod = "deleteBeMedRouteLkup",
        getMethod = "getBeMedRouteLkup",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.BeMedRouteLkupT",
        primaryKeys = {})
public class BusinessEntityMedicationRouteLookup extends BaseObject {
    ...
    @XmlAttribute(name = "Business_Entity_Medication_Route_Lookup_SK", required = true)
    @SerializedName("BusinessEntityMedicationRouteLookupSK")
	@Mapping(getter = "getBeMedRouteLkupSk", setter = "setBeMedRouteLkupSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger businessEntityMedicationRouteLookupSK;
    ...
    @XmlAttribute(name = "Medication_Route_Name", required = true)
    @SerializedName("MedicationRouteName")
	@Mapping(getter = "getMedRouteName", setter = "setMedRouteName", type = "String", index = 11)
    protected String medicationRouteName;
    @XmlAttribute(name = "Medication_Route_Description")
    @SerializedName("MedicationRouteDescription")
	@Mapping(getter = "getMedRouteDesc", setter = "setMedRouteDesc", type = "String", index = 12)
    protected String medicationRouteDescription;
    ...
    /**
     * Gets the value of the businessEntityMedicationRouteLookupSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getBusinessEntityMedicationRouteLookupSK() {
        return businessEntityMedicationRouteLookupSK;
    }

    /**
     * Sets the value of the businessEntityMedicationRouteLookupSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setBusinessEntityMedicationRouteLookupSK(BigInteger value) {
        this.businessEntityMedicationRouteLookupSK = value;
    }
    ...
    /**
     * Gets the value of the medicationRouteDescription property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getMedicationRouteDescription() {
        return medicationRouteDescription;
    }

    /**
     * Sets the value of the medicationRouteDescription property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setMedicationRouteDescription(String value) {
        this.medicationRouteDescription = value;
    }
