...
/**
 * <p>Java class for Business_Entity_Reference_Lookup complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Business_Entity_Reference_Lookup">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;attribute name="Business_Entity_Reference_Lookup_SK" use="required" type="{}Surrogate_Key" />
 ...
 *       &lt;attribute name="Reference_Name" type="{}Name_Generic" />
 *       &lt;attribute name="Reference_Description" type="{}Description_Short" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "Business_Entity_Reference_Lookup")
@OracleMetadata(
        packageName = "PKG_AM",
        insertMethod = "insertBeRefLkup",
        updateMethod = "updateBeRefLkup",
        deleteMethod = "deleteBeRefLkup",
        getMethod = "getBeRefLkup",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.BeRefLkupT",
        primaryKeys = {})
public class BusinessEntityReferenceLookup extends BaseObject {

	private static final long serialVersionUID = 1L;

    @XmlAttribute(name = "Business_Entity_Reference_Lookup_SK", required = true)
    @SerializedName("BusinessEntityReferenceLookupSK")
	@Mapping(getter = "getBeRefLkupSk", setter = "setBeRefLkupSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger businessEntityReferenceLookupSK;
	...
	@Mapping(getter = "getRefId", setter = "setRefId", type = "String", index = 10)
    ...
    @XmlAttribute(name = "Reference_Name")
    @SerializedName("ReferenceName")
	@Mapping(getter = "getRefName", setter = "setRefName", type = "String", index = 12)
    protected String referenceName;
    @XmlAttribute(name = "Reference_Description")
    @SerializedName("ReferenceDescription")
	@Mapping(getter = "getRefDesc", setter = "setRefDesc", type = "String", index = 13)
    protected String referenceDescription;

    /**
     * Gets the value of the businessEntityReferenceLookupSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getBusinessEntityReferenceLookupSK() {
        return businessEntityReferenceLookupSK;
    }

    /**
     * Sets the value of the businessEntityReferenceLookupSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setBusinessEntityReferenceLookupSK(BigInteger value) {
        this.businessEntityReferenceLookupSK = value;
    }
