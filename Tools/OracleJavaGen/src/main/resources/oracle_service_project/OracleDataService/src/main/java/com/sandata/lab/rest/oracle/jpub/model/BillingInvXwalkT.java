...
public class BillingInvXwalkT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "COREDATA.BILLING_INV_XWALK_T";
  ...
  protected static final BillingInvXwalkT _BillingInvXwalkTFactory = new BillingInvXwalkT();

  public static ORADataFactory getORADataFactory()
  { return _BillingInvXwalkTFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[15], _sqlType, _factory); }
  public BillingInvXwalkT()
  { _init_struct(true); }
  public BillingInvXwalkT(java.math.BigDecimal billingInvXwalkSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, java.sql.Timestamp recEffTmstp, java.sql.Timestamp recTermTmstp, String recCreatedBy, String recUpdatedBy, String changeReasonMemo, java.math.BigDecimal currRecInd, java.math.BigDecimal changeVersionId, String beId, String invNum, String payerId, String contrId, String ptId) throws SQLException
  { _init_struct(true);
    setBillingInvXwalkSk(billingInvXwalkSk);
  ...
  protected ORAData create(BillingInvXwalkT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new BillingInvXwalkT();
    o._struct = new MutableStruct((STRUCT) d, _sqlType, _factory);
    return o;
  }
  /* accessor methods */
  public java.math.BigDecimal getBillingInvXwalkSk() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(0); }

  public void setBillingInvXwalkSk(java.math.BigDecimal billingInvXwalkSk) throws SQLException
  { _struct.setAttribute(0, billingInvXwalkSk); }
