...
/**
 * A reference table used to define the unique list of Visit Event Type values available for use within the system.
 * 
 * Telephony
 * FVV
 * UI
 * 
 * <p>Java class for Visit_Event_Type_Lookup complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Visit_Event_Type_Lookup">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element ref="{}Visit_Event" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attribute name="Visit_Event_Type_Lookup_SK" use="required" type="{}Surrogate_Key" />
 ...
 *       &lt;attribute name="Visit_Event_Type_Description" type="{}Description_Short" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "Visit_Event_Type_Lookup", propOrder = {
    "visitEvent"
})
@OracleMetadata(
        packageName = "PKG_LOOKUP",
        insertMethod = "insertVisitEvntTypLkup",
        updateMethod = "updateVisitEvntTypLkup",
        deleteMethod = "deleteVisitEvntTypLkup",
        getMethod = "getVisitEvntTypLkup",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.VisitEvntTypLkupT",
        primaryKeys = {})
public class VisitEventTypeLookup extends BaseObject {
    ...
    @XmlAttribute(name = "Visit_Event_Type_Lookup_SK", required = true)
    @SerializedName("VisitEventTypeLookupSK")
	@Mapping(getter = "getVisitEvntTypLkupSk", setter = "setVisitEvntTypLkupSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger visitEventTypeLookupSK;
	...
	@Mapping(getter = "getVisitEvntTypCode", setter = "setVisitEvntTypCode", type = "String", index = 10)
    protected VisitEventTypeCode visitEventTypeCode;
    @XmlAttribute(name = "Visit_Event_Type_Description")
    @SerializedName("VisitEventTypeDescription")
	@Mapping(getter = "getVisitEvntTypDesc", setter = "setVisitEvntTypDesc", type = "String", index = 11)
    protected String visitEventTypeDescription;
    ...
    /**
     * Gets the value of the visitEventTypeLookupSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getVisitEventTypeLookupSK() {
        return visitEventTypeLookupSK;
    }

    /**
     * Sets the value of the visitEventTypeLookupSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setVisitEventTypeLookupSK(BigInteger value) {
        this.visitEventTypeLookupSK = value;
    }
    ...
    /**
     * Gets the value of the visitEventTypeDescription property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getVisitEventTypeDescription() {
        return visitEventTypeDescription;
    }

    /**
     * Sets the value of the visitEventTypeDescription property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setVisitEventTypeDescription(String value) {
        this.visitEventTypeDescription = value;
    }
