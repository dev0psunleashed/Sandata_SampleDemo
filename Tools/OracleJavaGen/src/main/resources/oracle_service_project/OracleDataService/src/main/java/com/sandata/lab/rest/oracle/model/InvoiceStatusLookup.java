 ...
 * 
 * <p>Java class for Invoice_Status_Lookup complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Invoice_Status_Lookup">
 *   &lt;complexContent>
 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Invoice_Status_Lookup_SK" use="required" type="{}Surrogate_Key" />
 ...
 *       &lt;attribute name="Invoice_Status_Code" use="required" type="{}Invoice_Status_Code" />
 *       &lt;attribute name="Invoice_Status_Name" type="{}Name_Generic" />
 *       &lt;attribute name="Invoice_Status_Description" type="{}Description_Short" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "Invoice_Status_Lookup", propOrder = {
    "invoice",
    "accountsReceivable",
    "billing"
})
@OracleMetadata(
        ...
        insertMethod = "insertInvStatusLkup",
        updateMethod = "updateInvStatusLkup",
        deleteMethod = "deleteInvStatusLkup",
        getMethod = "getInvStatusLkup",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.InvStatusLkupT",
        primaryKeys = {})
public class InvoiceStatusLookup extends BaseObject {
    ...
    @XmlAttribute(name = "Invoice_Status_Lookup_SK", required = true)
    @SerializedName("InvoiceStatusLookupSK")
	@Mapping(getter = "getInvStatusLkupSk", setter = "setInvStatusLkupSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger invoiceStatusLookupSK;
    ...
    @XmlAttribute(name = "Invoice_Status_Code", required = true)
    @SerializedName("InvoiceStatusCode")
	@Mapping(getter = "getInvStatusCode", setter = "setInvStatusCode", type = "String", index = 10)
    protected String invoiceStatusCode;
    @XmlAttribute(name = "Invoice_Status_Name")
    @SerializedName("InvoiceStatusName")
	@Mapping(getter = "getInvStatusName", setter = "setInvStatusName", type = "String", index = 11)
    protected String invoiceStatusName;
    @XmlAttribute(name = "Invoice_Status_Description")
    @SerializedName("InvoiceStatusDescription")
	@Mapping(getter = "getInvStatusDesc", setter = "setInvStatusDesc", type = "String", index = 12)
    protected String invoiceStatusDescription;
    ...
    /**
     * Gets the value of the invoiceStatusLookupSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getInvoiceStatusLookupSK() {
        return invoiceStatusLookupSK;
    }

    /**
     * Sets the value of the invoiceStatusLookupSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setInvoiceStatusLookupSK(BigInteger value) {
        this.invoiceStatusLookupSK = value;
    }
     ...
     *     
     */
    public void setInvoiceStatusName(String value) {
        this.invoiceStatusName = value;
    }

    /**
     * Gets the value of the invoiceStatusDescription property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the invoiceStatusDescription property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setInvoiceStatusDescription(String value) {
        this.invoiceStatusDescription = value;
    }
