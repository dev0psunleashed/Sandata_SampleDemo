...
@XmlType(name = "Application_User_Role")
@OracleMetadata(
        packageName = "PKG_APP",
        ...
        primaryKeys = {})
public class ApplicationUserRole extends BaseObject extends BaseObject extends BaseObject extends BaseObject {
    ...
    @SerializedName("ApplicationUserRoleSK")
    @SerializedName("ApplicationUserRoleSK")
	@Mapping(getter = "getAppUserRoleSk", setter = "setAppUserRoleSk", type = "java.math.BigDecimal", index = 0)
    ...
    @SerializedName("ApplicationUserSK")
    @SerializedName("ApplicationUserSK")
	@Mapping(getter = "getAppUserSk", setter = "setAppUserSk", type = "java.math.BigDecimal", index = 4)
    ...
    @SerializedName("ActiveRoleIndicator")
    @SerializedName("ActiveRoleIndicator")
	@Mapping(getter = "getActiveRoleInd", setter = "setActiveRoleInd", type = "java.math.BigDecimal", index = 6)
