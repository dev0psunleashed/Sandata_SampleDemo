...
public class ContrBillingCodeLstT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "COREDATA.CONTR_BILLING_CODE_LST_T";
  ...
  protected static final ContrBillingCodeLstT _ContrBillingCodeLstTFactory = new ContrBillingCodeLstT();

  public static ORADataFactory getORADataFactory()
  { return _ContrBillingCodeLstTFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[14], _sqlType, _factory); }
  public ContrBillingCodeLstT()
  { _init_struct(true); }
  public ContrBillingCodeLstT(java.math.BigDecimal contrBillingCodeLstSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, java.sql.Timestamp recEffTmstp, java.sql.Timestamp recTermTmstp, String recCreatedBy, String recUpdatedBy, String changeReasonMemo, java.math.BigDecimal currRecInd, java.math.BigDecimal changeVersionId, String beId, String payerId, String contrId, String billingCode) throws SQLException
  { _init_struct(true);
    setContrBillingCodeLstSk(contrBillingCodeLstSk);
  ...
  protected ORAData create(ContrBillingCodeLstT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new ContrBillingCodeLstT();
    o._struct = new MutableStruct((STRUCT) d, _sqlType, _factory);
    return o;
  }
  /* accessor methods */
  public java.math.BigDecimal getContrBillingCodeLstSk() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(0); }

  public void setContrBillingCodeLstSk(java.math.BigDecimal contrBillingCodeLstSk) throws SQLException
  { _struct.setAttribute(0, contrBillingCodeLstSk); }
