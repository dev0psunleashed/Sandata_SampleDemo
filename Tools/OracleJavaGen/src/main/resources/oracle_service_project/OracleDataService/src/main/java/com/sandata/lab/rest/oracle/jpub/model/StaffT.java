...
public class StaffT implements ORAData, ORADataFactory
{
  ...
  protected static int[] _sqlType =  { 2,12,91,91,91,91,12,12,12,12,2,2,12,12,12,91,12,12,12,12,12,12,12,2,12,12,12,12,12,12,12,12,12,91,91,12,91,12,91,12,12,12,12,12,2,2,2,12,12,12,12,12,12,12,12 };
  ...
  { _init_struct(true);
    ...
    setStaffHireDateQlfr(staffHireDateQlfr);
  ...
  public String getStaffHireDateQlfr() throws SQLException
  { return (String) _struct.getAttribute(35); }

  public void setStaffHireDateQlfr(String staffHireDateQlfr) throws SQLException
  { _struct.setAttribute(35, staffHireDateQlfr); }
  ...
  { _struct.setAttribute(36, staffLastRaiseDate); }
  ...
  { _struct.setAttribute(37, staffMrtlStatusName); }
  ...
  { _struct.setAttribute(38, staffDob); }
  ...
  { _struct.setAttribute(39, staffGenderTypName); }
  ...
  { _struct.setAttribute(40, staffRaceEthnicityCode); }
  ...
  { _struct.setAttribute(41, staffEducation); }
  ...
  { _struct.setAttribute(42, staffReligionCode); }
  ...
  { _struct.setAttribute(43, staffTransportMthd); }
  ...
  { _struct.setAttribute(44, staffTravelRadius); }
  ...
  { _struct.setAttribute(45, staffOnOkInd); }
  ...
  { _struct.setAttribute(46, staffLiOkInd); }
  ...
  { _struct.setAttribute(47, staffTeam); }
  ...
  { _struct.setAttribute(48, staffMilitaryRec); }
  ...
  { _struct.setAttribute(49, staffRfrlTyp); }
  ...
  { _struct.setAttribute(50, staffRfrlName); }
  ...
  { _struct.setAttribute(51, staffRfrlInstitution); }
  ...
  { _struct.setAttribute(52, staffRfrlCmnt); }
  ...
  { _struct.setAttribute(53, staffPositionName); }
  ...
  { _struct.setAttribute(54, staffRfrlTypName); }
