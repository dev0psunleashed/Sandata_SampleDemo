 ...
 * 
 * <p>Java class for Business_Entity_Document_Crosswalk complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Business_Entity_Document_Crosswalk">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;attribute name="Business_Entity_Document_Crosswalk_SK" use="required" type="{}Surrogate_Key" />
...
@XmlType(name = "Business_Entity_Document_Crosswalk")
@OracleMetadata(
        packageName = "PKG_DOCXWALK",
        insertMethod = "insertBeDocXwalk",
        updateMethod = "updateBeDocXwalk",
        deleteMethod = "deleteBeDocXwalk",
        getMethod = "getBeDocXwalk",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.BeDocXwalkT",
        primaryKeys = {})
public class BusinessEntityDocumentCrosswalk extends BaseObject {

	private static final long serialVersionUID = 1L;

    @XmlAttribute(name = "Business_Entity_Document_Crosswalk_SK", required = true)
    @SerializedName("BusinessEntityDocumentCrosswalkSK")
	@Mapping(getter = "getBeDocXwalkSk", setter = "setBeDocXwalkSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger businessEntityDocumentCrosswalkSK;
	...
	@Mapping(getter = "getDocClasName", setter = "setDocClasName", type = "String", index = 11)
    protected String documentClassificationName;

    /**
     * Gets the value of the businessEntityDocumentCrosswalkSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getBusinessEntityDocumentCrosswalkSK() {
        return businessEntityDocumentCrosswalkSK;
    }

    /**
     * Sets the value of the businessEntityDocumentCrosswalkSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setBusinessEntityDocumentCrosswalkSK(BigInteger value) {
        this.businessEntityDocumentCrosswalkSK = value;
    }
