...
public class ContrMdfrLstT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "COREDATA.CONTR_MDFR_LST_T";
  ...
  protected static final ContrMdfrLstT _ContrMdfrLstTFactory = new ContrMdfrLstT();

  public static ORADataFactory getORADataFactory()
  { return _ContrMdfrLstTFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[14], _sqlType, _factory); }
  public ContrMdfrLstT()
  { _init_struct(true); }
  public ContrMdfrLstT(java.math.BigDecimal contrMdfrLstSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, java.sql.Timestamp recEffTmstp, java.sql.Timestamp recTermTmstp, String recCreatedBy, String recUpdatedBy, String changeReasonMemo, java.math.BigDecimal currRecInd, java.math.BigDecimal changeVersionId, String beId, String payerId, String contrId, String mdfrCode) throws SQLException
  { _init_struct(true);
    setContrMdfrLstSk(contrMdfrLstSk);
  ...
  protected ORAData create(ContrMdfrLstT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new ContrMdfrLstT();
    o._struct = new MutableStruct((STRUCT) d, _sqlType, _factory);
    return o;
  }
  /* accessor methods */
  public java.math.BigDecimal getContrMdfrLstSk() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(0); }

  public void setContrMdfrLstSk(java.math.BigDecimal contrMdfrLstSk) throws SQLException
  { _struct.setAttribute(0, contrMdfrLstSk); }
  ...
  { _struct.setAttribute(13, mdfrCode); }
