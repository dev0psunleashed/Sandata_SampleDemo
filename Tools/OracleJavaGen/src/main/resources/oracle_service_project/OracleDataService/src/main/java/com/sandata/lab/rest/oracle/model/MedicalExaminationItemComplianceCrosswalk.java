...
@XmlType(name = "Medical_Examination_Item_Compliance_Crosswalk")
@OracleMetadata(
        packageName = "PKG_MEDICAL",
        insertMethod = "insertMedclExamItemCompXwalk",
        updateMethod = "updateMedclExamItemCompXwalk",
        deleteMethod = "deleteMedclExamItemCompXwalk",
        getMethod = "getMedclExamItemCompXwalk",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.MedclExamItemCompXwalkT",
        primaryKeys = {})
public class MedicalExaminationItemComplianceCrosswalk extends BaseObject {

	private static final long serialVersionUID = 1L;

    @XmlAttribute(name = "Medical_Examination_Item_Compliance_Crosswalk_SK", required = true)
    @SerializedName("MedicalExaminationItemComplianceCrosswalkSK")
	@Mapping(getter = "getMedclExamItemCompXwalkSk", setter = "setMedclExamItemCompXwalkSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger medicalExaminationItemComplianceCrosswalkSK;
    ...
    /**
     * Gets the value of the medicalExaminationItemComplianceCrosswalkSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getMedicalExaminationItemComplianceCrosswalkSK() {
        return medicalExaminationItemComplianceCrosswalkSK;
    }

    /**
     * Sets the value of the medicalExaminationItemComplianceCrosswalkSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setMedicalExaminationItemComplianceCrosswalkSK(BigInteger value) {
        this.medicalExaminationItemComplianceCrosswalkSK = value;
    }
