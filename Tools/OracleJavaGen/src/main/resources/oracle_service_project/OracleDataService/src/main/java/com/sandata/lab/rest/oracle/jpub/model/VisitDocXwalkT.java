...
public class VisitDocXwalkT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "COREDATA.VISIT_DOC_XWALK_T";
  public static final int _SQL_TYPECODE = OracleTypes.STRUCT;

  protected MutableStruct _struct;

  protected static int[] _sqlType =  { 2,91,91,91,91,12,12,2,2,12,2,12,12 };
  protected static ORADataFactory[] _factory = new ORADataFactory[13];
  protected static final VisitDocXwalkT _VisitDocXwalkTFactory = new VisitDocXwalkT();

  public static ORADataFactory getORADataFactory()
  { return _VisitDocXwalkTFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[13], _sqlType, _factory); }
  public VisitDocXwalkT()
  { _init_struct(true); }
  public VisitDocXwalkT(java.math.BigDecimal visitDocXwalkSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, java.sql.Timestamp recEffTmstp, java.sql.Timestamp recTermTmstp, String recCreatedBy, String changeReasonMemo, java.math.BigDecimal currRecInd, java.math.BigDecimal changeVersionId, String beId, java.math.BigDecimal visitSk, String docId, String docClasName) throws SQLException
  { _init_struct(true);
    setVisitDocXwalkSk(visitDocXwalkSk);
  ...
  protected ORAData create(VisitDocXwalkT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new VisitDocXwalkT();
    o._struct = new MutableStruct((STRUCT) d, _sqlType, _factory);
    return o;
  }
  /* accessor methods */
  public java.math.BigDecimal getVisitDocXwalkSk() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(0); }

  public void setVisitDocXwalkSk(java.math.BigDecimal visitDocXwalkSk) throws SQLException
  { _struct.setAttribute(0, visitDocXwalkSk); }
