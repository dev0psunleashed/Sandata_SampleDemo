CREATE OR REPLACE TYPE TRANSPORT_MODE_LKUP_T AS OBJECT (
TRANSPORT_MODE_LKUP_SK	NUMBER(38),
...
TRANSPORT_MODE_NAME	VARCHAR2(50 BYTE),
TRANSPORT_MODE_DESC	VARCHAR2(250 BYTE)
);
/
