CREATE OR REPLACE TYPE BE_STAFF_WRK_PREF_LKUP_T AS OBJECT (
BE_STAFF_WRK_PREF_LKUP_SK	NUMBER(38),
...
STAFF_WRK_PREF_NAME	VARCHAR2(100 BYTE),
STAFF_WRK_PREF_DESC	VARCHAR2(250 BYTE)
);
/
