CREATE OR REPLACE TYPE INV_DET_STATUS_LKUP_T AS OBJECT (
INV_DET_STATUS_LKUP_SK	NUMBER(38),
...
INV_DET_STATUS_NAME	VARCHAR2(100 BYTE),
INV_DET_STATUS_DESC	VARCHAR2(250 BYTE)
);
/
