CREATE OR REPLACE TYPE BE_RATE_TYP_LKUP_T AS OBJECT (
BE_RATE_TYP_LKUP_SK	NUMBER(38),
...
RATE_TYP_DESC	VARCHAR2(250 BYTE),
RATE_TYP_EFF_DATE DATE,
RATE_TYP_TERM_DATE DATE
);
/
