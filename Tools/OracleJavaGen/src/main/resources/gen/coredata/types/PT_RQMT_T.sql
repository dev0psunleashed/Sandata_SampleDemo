CREATE OR REPLACE TYPE PT_RQMT_T AS OBJECT (
PT_RQMT_SK	NUMBER(38),
PT_RQMT_ID	VARCHAR2(50 BYTE),
...
PT_RQMT_NAME	VARCHAR2(100 BYTE),
STAFF_SPECIALTY_TRNG	VARCHAR2(50 BYTE),
PT_RESTRICTION_COMMENT	VARCHAR2(1000 BYTE)
);
/
