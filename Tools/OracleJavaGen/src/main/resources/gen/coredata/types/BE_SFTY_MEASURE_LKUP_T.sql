CREATE OR REPLACE TYPE BE_SFTY_MEASURE_LKUP_T AS OBJECT (
BE_SFTY_MEASURE_LKUP_SK	NUMBER(38),
...
SFTY_MEASURE_ID	VARCHAR2(50 BYTE),
SFTY_MEASURE_NAME	VARCHAR2(100 BYTE),
SFTY_MEASURE_DESC	VARCHAR2(250 BYTE)
);
/
