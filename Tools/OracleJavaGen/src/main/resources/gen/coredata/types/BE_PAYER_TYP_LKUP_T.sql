CREATE OR REPLACE TYPE BE_PAYER_TYP_LKUP_T AS OBJECT (
BE_PAYER_TYP_LKUP_SK	NUMBER(38),
...
PAYER_TYP_ID	VARCHAR2(50 BYTE),
PAYER_TYP_NAME	VARCHAR2(50 BYTE),
PAYER_TYP_DESC	VARCHAR2(250 BYTE)
);
/
