CREATE OR REPLACE TYPE BE_LOB_LKUP_T AS OBJECT (
BE_LOB_LKUP_SK	NUMBER(38),
...
BE_LOB	VARCHAR2(100 BYTE),
BE_LOB_DESC	VARCHAR2(250 BYTE),
BE_LOB_EFF_DATE DATE,
BE_LOB_TERM_DATE DATE
);
/
