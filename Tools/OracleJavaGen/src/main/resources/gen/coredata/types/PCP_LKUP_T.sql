CREATE OR REPLACE TYPE PCP_LKUP_T AS OBJECT (
PCP_LKUP_SK	NUMBER(38),
...
PCP_ID	VARCHAR2(50 BYTE),
PCP_PROVIDER_NAME	VARCHAR2(100 BYTE),
PCP_PHONE	VARCHAR2(10 BYTE),
PCP_TYP_NAME	VARCHAR2(50 BYTE)
);
/
