CREATE OR REPLACE TYPE BE_SKILL_LKUP_T AS OBJECT (
BE_SKILL_LKUP_SK	NUMBER(38),
...
SKILL_ID	VARCHAR2(50 BYTE),
SKILL_NAME	VARCHAR2(100 BYTE),
SKILL_DESC	VARCHAR2(250 BYTE),
SKILL_EFF_DATE DATE,
SKILL_TERM_DATE DATE
);
/
