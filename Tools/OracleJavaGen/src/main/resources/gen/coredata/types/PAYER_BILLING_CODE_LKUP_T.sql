CREATE OR REPLACE TYPE PAYER_BILLING_CODE_LKUP_T AS OBJECT (
PAYER_BILLING_CODE_LKUP_SK	NUMBER(38),
...
BILLING_CODE_SHORT_DESC	VARCHAR2(250 BYTE),
BILLING_CODE_LONG_DESC	VARCHAR2(2000 BYTE),
BILLING_CODE_EFF_DATE DATE,
BILLING_CODE_TERM_DATE DATE
);
/
