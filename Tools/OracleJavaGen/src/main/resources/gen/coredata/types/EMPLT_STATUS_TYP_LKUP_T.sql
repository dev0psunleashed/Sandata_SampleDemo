CREATE OR REPLACE TYPE EMPLT_STATUS_TYP_LKUP_T AS OBJECT (
EMPLT_STATUS_TYP_LKUP_SK	NUMBER(38),
...
EMPLT_STATUS_TYP_NAME	VARCHAR2(50 BYTE),
EMPLT_STATUS_TYP_DESC	VARCHAR2(250 BYTE)
);
/
