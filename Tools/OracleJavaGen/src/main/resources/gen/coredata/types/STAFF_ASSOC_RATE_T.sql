CREATE OR REPLACE TYPE STAFF_ASSOC_RATE_T AS OBJECT (
STAFF_ASSOC_RATE_SK	NUMBER(38),
...
STAFF_ASSOC_RATE_EFF_DATE DATE,
STAFF_ASSOC_RATE_TERM_DATE DATE,
SVC_NAME	VARCHAR2(20 BYTE),
RATE_SUB_TYP_NAME	VARCHAR2(50 BYTE),
RATE_TYP_NAME	VARCHAR2(20 BYTE),
RATE_QLFR_CODE	VARCHAR2(4 BYTE),
RATE_CHANGE_QLFR	VARCHAR2(50 BYTE),
STAFF_ASSOC_RATE_AMT	NUMBER(7, 2)
);
/
