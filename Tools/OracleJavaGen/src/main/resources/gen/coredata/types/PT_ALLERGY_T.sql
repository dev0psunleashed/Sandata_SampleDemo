CREATE OR REPLACE TYPE PT_ALLERGY_T AS OBJECT (
PT_ALLERGY_SK	NUMBER(38),
PT_ALLERGY_ID	VARCHAR2(50 BYTE),
...
ALLERGY_NAME	VARCHAR2(100 BYTE),
PT_ALLERGY_MED_NAME	VARCHAR2(100 BYTE)
);
/
