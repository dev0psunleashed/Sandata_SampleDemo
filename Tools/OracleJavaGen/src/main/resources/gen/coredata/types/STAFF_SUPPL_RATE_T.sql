CREATE OR REPLACE TYPE STAFF_SUPPL_RATE_T AS OBJECT (
STAFF_SUPPL_RATE_SK	NUMBER(38),
...
STAFF_SUPPL_RATE_EFF_DATE DATE,
STAFF_SUPPL_RATE_TERM_DATE DATE,
STAFF_SUPPL_RATE_CHANGE_QLFR	VARCHAR2(50 BYTE),
SVC_NAME	VARCHAR2(20 BYTE),
RATE_SUB_TYP_NAME	VARCHAR2(50 BYTE),
RATE_TYP_NAME	VARCHAR2(20 BYTE),
RATE_QLFR_CODE	VARCHAR2(4 BYTE),
STAFF_SUPPL_RATE	NUMBER(7, 2)
);
/
