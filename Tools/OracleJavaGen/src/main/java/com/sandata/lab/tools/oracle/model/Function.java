...
public class Function {
    ...
    public String toPackage() {
        ...
        // NOTE:    LONG_NUMBER is not a valid Oracle Type, it is just used to determine if the Java function will
        //          return a long
        String returnValue = (getReturnType().equals(Parameter.LONG_NUMBER)) ? Parameter.NUMBER : getReturnType();
        ...
        if (parameters != null) {
            ...
            packageFunction.append(String.format("%s %s", parameter.getName(), parameter.getType()));
            packageFunction.append(String.format(") RETURN %s", returnValue));
        }
        else {
