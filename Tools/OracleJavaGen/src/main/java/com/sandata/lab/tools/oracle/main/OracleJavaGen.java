        ...
        try {
            ...
            for (OraclePackage oraclePackage : oraclePackages) {
                ...
                for (Table table : oraclePackage.getTables()) {
                    ...
                    TableUtil.DropType(connection, String.format("%s_T", table.getShortName()));
            ...
            //dmr--MetadataMapper.getInstance(packageManager.getMetadataMap()).process();

            System.out.println("OracleJavaGen: Complete!");
        }
        catch (Exception e) {
            e.printStackTrace();
        }
