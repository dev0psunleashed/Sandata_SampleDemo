...
public class BeCompSvcLstT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "COREDATA.BE_COMP_SVC_LST_T";
  ...
  protected static final BeCompSvcLstT _BeCompSvcLstTFactory = new BeCompSvcLstT();

  public static ORADataFactory getORADataFactory()
  { return _BeCompSvcLstTFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[13], _sqlType, _factory); }
  public BeCompSvcLstT()
  { _init_struct(true); }
  public BeCompSvcLstT(java.math.BigDecimal beCompSvcLstSk, java.sql.Timestamp recCreateTmstpHist, java.sql.Timestamp recUpdateTmstp, java.sql.Timestamp recEffTmstp, java.sql.Timestamp recTermTmstp, String recCreatedBy, String recUpdatedBy, String changeReasonMemo, java.math.BigDecimal currRecInd, java.math.BigDecimal changeVersionId, String beId, String compCode, String svcName) throws SQLException
  { _init_struct(true);
    setBeCompSvcLstSk(beCompSvcLstSk);
  ...
  protected ORAData create(BeCompSvcLstT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new BeCompSvcLstT();
    o._struct = new MutableStruct((STRUCT) d, _sqlType, _factory);
    return o;
  }
  /* accessor methods */
  public java.math.BigDecimal getBeCompSvcLstSk() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(0); }

  public void setBeCompSvcLstSk(java.math.BigDecimal beCompSvcLstSk) throws SQLException
  { _struct.setAttribute(0, beCompSvcLstSk); }
