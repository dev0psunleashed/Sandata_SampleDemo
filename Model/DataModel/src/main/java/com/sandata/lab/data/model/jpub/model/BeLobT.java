...
public class BeLobT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "COREDATA.BE_LOB_T";
  ...
  protected static final BeLobT _BeLobTFactory = new BeLobT();

  public static ORADataFactory getORADataFactory()
  { return _BeLobTFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[14], _sqlType, _factory); }
  public BeLobT()
  { _init_struct(true); }
  public BeLobT(java.math.BigDecimal beLobSk, String beLobId, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, java.sql.Timestamp recEffTmstp, java.sql.Timestamp recTermTmstp, String recCreatedBy, String recUpdatedBy, String changeReasonMemo, java.math.BigDecimal currRecInd, java.math.BigDecimal changeVersionId, String beId, String beLob, String beLobDesc) throws SQLException
  { _init_struct(true);
    setBeLobSk(beLobSk);
    setBeLobId(beLobId);
  ...
  protected ORAData create(BeLobT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new BeLobT();
    o._struct = new MutableStruct((STRUCT) d, _sqlType, _factory);
    return o;
  }
  /* accessor methods */
  public java.math.BigDecimal getBeLobSk() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(0); }

  public void setBeLobSk(java.math.BigDecimal beLobSk) throws SQLException
  { _struct.setAttribute(0, beLobSk); }
  ...
  { _struct.setAttribute(1, beLobId); }
  ...
  { _struct.setAttribute(13, beLobDesc); }
