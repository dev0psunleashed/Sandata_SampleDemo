...
public class AdminStaffStaffXrefT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "COREDATA.ADMIN_STAFF_STAFF_XREF_T";
  ...
  protected static final AdminStaffStaffXrefT _AdminStaffStaffXrefTFactory = new AdminStaffStaffXrefT();

  public static ORADataFactory getORADataFactory()
  { return _AdminStaffStaffXrefTFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[18], _sqlType, _factory); }
  public AdminStaffStaffXrefT()
  { _init_struct(true); }
  public AdminStaffStaffXrefT(java.math.BigDecimal adminStaffStaffXrefSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, java.sql.Timestamp recEffTmstp, java.sql.Timestamp recTermTmstp, String recCreatedBy, String recUpdatedBy, String changeReasonMemo, java.math.BigDecimal currRecInd, java.math.BigDecimal changeVersionId, String beId, String staffId, String adminStaffId, java.sql.Timestamp adminStaffStaffEffDate, java.sql.Timestamp adminStaffStaffTermDate, String adminStaffRoleName, java.sql.Timestamp adminStaffRoleEffDate, java.sql.Timestamp adminStaffRoleTermDate) throws SQLException
  { _init_struct(true);
    setAdminStaffStaffXrefSk(adminStaffStaffXrefSk);
  ...
  protected ORAData create(AdminStaffStaffXrefT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new AdminStaffStaffXrefT();
    o._struct = new MutableStruct((STRUCT) d, _sqlType, _factory);
    return o;
  }
  /* accessor methods */
  public java.math.BigDecimal getAdminStaffStaffXrefSk() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(0); }

  public void setAdminStaffStaffXrefSk(java.math.BigDecimal adminStaffStaffXrefSk) throws SQLException
  { _struct.setAttribute(0, adminStaffStaffXrefSk); }
  ...
  { _struct.setAttribute(12, adminStaffId); }
