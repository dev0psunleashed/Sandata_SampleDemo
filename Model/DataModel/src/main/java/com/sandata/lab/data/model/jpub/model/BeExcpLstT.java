...
public class BeExcpLstT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "COREDATA.BE_EXCP_LST_T";
  public static final int _SQL_TYPECODE = OracleTypes.STRUCT;

  protected MutableStruct _struct;

  protected static int[] _sqlType =  { 2,91,91,91,91,12,12,12,2,2,12,12,2,2,2 };
  protected static ORADataFactory[] _factory = new ORADataFactory[15];
  protected static final BeExcpLstT _BeExcpLstTFactory = new BeExcpLstT();

  public static ORADataFactory getORADataFactory()
  { return _BeExcpLstTFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[15], _sqlType, _factory); }
  public BeExcpLstT()
  { _init_struct(true); }
  public BeExcpLstT(java.math.BigDecimal beExcpLstSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, java.sql.Timestamp recEffTmstp, java.sql.Timestamp recTermTmstp, String recCreatedBy, String recUpdatedBy, String changeReasonMemo, java.math.BigDecimal currRecInd, java.math.BigDecimal changeVersionId, String beId, String appModName, java.math.BigDecimal excpId, java.math.BigDecimal excpNonFixableInd, java.math.BigDecimal excpAckInd) throws SQLException
  { _init_struct(true);
    setBeExcpLstSk(beExcpLstSk);
  ...
  protected ORAData create(BeExcpLstT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new BeExcpLstT();
    o._struct = new MutableStruct((STRUCT) d, _sqlType, _factory);
    return o;
  }
  /* accessor methods */
  public java.math.BigDecimal getBeExcpLstSk() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(0); }

  public void setBeExcpLstSk(java.math.BigDecimal beExcpLstSk) throws SQLException
  { _struct.setAttribute(0, beExcpLstSk); }
  ...
  { _struct.setAttribute(11, appModName); }
  ...
  { _struct.setAttribute(12, excpId); }
  ...
  { _struct.setAttribute(13, excpNonFixableInd); }
  ...
  { _struct.setAttribute(14, excpAckInd); }
