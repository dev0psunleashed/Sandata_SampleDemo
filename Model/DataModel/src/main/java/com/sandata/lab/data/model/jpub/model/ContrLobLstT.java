...
public class ContrLobLstT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "COREDATA.CONTR_LOB_LST_T";
  ...
  protected static final ContrLobLstT _ContrLobLstTFactory = new ContrLobLstT();

  public static ORADataFactory getORADataFactory()
  { return _ContrLobLstTFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[14], _sqlType, _factory); }
  public ContrLobLstT()
  { _init_struct(true); }
  public ContrLobLstT(java.math.BigDecimal contrLobLstSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, java.sql.Timestamp recEffTmstp, java.sql.Timestamp recTermTmstp, String recCreatedBy, String recUpdatedBy, String changeReasonMemo, java.math.BigDecimal currRecInd, java.math.BigDecimal changeVersionId, String beId, String payerId, String contrId, String beLob) throws SQLException
  { _init_struct(true);
    setContrLobLstSk(contrLobLstSk);
  ...
  protected ORAData create(ContrLobLstT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new ContrLobLstT();
    o._struct = new MutableStruct((STRUCT) d, _sqlType, _factory);
    return o;
  }
  /* accessor methods */
  public java.math.BigDecimal getContrLobLstSk() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(0); }

  public void setContrLobLstSk(java.math.BigDecimal contrLobLstSk) throws SQLException
  { _struct.setAttribute(0, contrLobLstSk); }
