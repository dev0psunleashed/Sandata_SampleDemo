...
public class PayerT implements ORAData, ORADataFactory
{
  ...
  protected static int[] _sqlType =  { 2,91,91,91,91,12,12,12,2,2,12,12,12,12,12,12,91,91,12,12,12,12,12,12,12,12,12,12,1,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,1,12,12,12,12,12,12,12,12,12,1,12,12,12,12,12,12,2,12,12,12,12,12,12,12,12,12,2,2,2,2,2,2,2,2,2,2,2,12,12,12,12,12,12,12,12,12,12,12,12,12,2,12,12,12,2 };
  protected static ORADataFactory[] _factory = new ORADataFactory[104];
  ...
  { _init_struct(true);
    ...
    setPayerSvcNonOvrlpInd(payerSvcNonOvrlpInd);
  }
  ...
  public java.math.BigDecimal getPayerSvcNonOvrlpInd() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(103); }

  public void setPayerSvcNonOvrlpInd(java.math.BigDecimal payerSvcNonOvrlpInd) throws SQLException
  { _struct.setAttribute(103, payerSvcNonOvrlpInd); }
