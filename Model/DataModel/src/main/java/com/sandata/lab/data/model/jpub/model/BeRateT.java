...
public class BeRateT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "COREDATA.BE_RATE_T";
  ...
  protected static final BeRateT _BeRateTFactory = new BeRateT();

  public static ORADataFactory getORADataFactory()
  { return _BeRateTFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[21], _sqlType, _factory); }
  public BeRateT()
  { _init_struct(true); }
  public BeRateT(java.math.BigDecimal beRateSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, java.sql.Timestamp recEffTmstp, java.sql.Timestamp recTermTmstp, String recCreatedBy, String recUpdatedBy, String changeReasonMemo, java.math.BigDecimal currRecInd, java.math.BigDecimal changeVersionId, String beId, String beLobId, String beLocId, java.sql.Timestamp beRateEffDate, java.sql.Timestamp beRateTermDate, String svcName, String rateSubTypName, String rateTypName, String rateQlfrCode, String svcUnitName, java.math.BigDecimal beRateAmt) throws SQLException
  { _init_struct(true);
    setBeRateSk(beRateSk);
  ...
  protected ORAData create(BeRateT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new BeRateT();
    o._struct = new MutableStruct((STRUCT) d, _sqlType, _factory);
    return o;
  }
  /* accessor methods */
  public java.math.BigDecimal getBeRateSk() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(0); }

  public void setBeRateSk(java.math.BigDecimal beRateSk) throws SQLException
  { _struct.setAttribute(0, beRateSk); }
  ...
  public java.sql.Timestamp getBeRateEffDate() throws SQLException
  { return (java.sql.Timestamp) _struct.getAttribute(13); }

  public void setBeRateEffDate(java.sql.Timestamp beRateEffDate) throws SQLException
  { _struct.setAttribute(13, beRateEffDate); }


  public java.sql.Timestamp getBeRateTermDate() throws SQLException
  { return (java.sql.Timestamp) _struct.getAttribute(14); }

  public void setBeRateTermDate(java.sql.Timestamp beRateTermDate) throws SQLException
  { _struct.setAttribute(14, beRateTermDate); }
  ...
  public java.math.BigDecimal getBeRateAmt() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(20); }

  public void setBeRateAmt(java.math.BigDecimal beRateAmt) throws SQLException
  { _struct.setAttribute(20, beRateAmt); }
