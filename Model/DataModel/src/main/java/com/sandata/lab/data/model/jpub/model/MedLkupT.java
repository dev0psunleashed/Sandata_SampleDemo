...
public class MedLkupT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "COREDATA.MED_LKUP_T";
  public static final int _SQL_TYPECODE = OracleTypes.STRUCT;

  protected MutableStruct _struct;

  protected static int[] _sqlType =  { 2,91,91,91,91,12,12,12,2,2,12,12,12,12,12,12,12,12,12,12,12 };
  protected static ORADataFactory[] _factory = new ORADataFactory[21];
  protected static final MedLkupT _MedLkupTFactory = new MedLkupT();

  public static ORADataFactory getORADataFactory()
  { return _MedLkupTFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[21], _sqlType, _factory); }
  public MedLkupT()
  { _init_struct(true); }
  public MedLkupT(java.math.BigDecimal medLkupSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, java.sql.Timestamp recEffTmstp, java.sql.Timestamp recTermTmstp, String recCreatedBy, String recUpdatedBy, String changeReasonMemo, java.math.BigDecimal currRecInd, java.math.BigDecimal changeVersionId, String medNdcCode, String medGenericName, String medPtyName, String medInnName, String medChemicalName, String medClasName, String medMfgCode, String medMfgName, String medPackageDesc, String medNcpdpUomCode, String medDesc) throws SQLException
  { _init_struct(true);
    setMedLkupSk(medLkupSk);
  ...
  protected ORAData create(MedLkupT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new MedLkupT();
    o._struct = new MutableStruct((STRUCT) d, _sqlType, _factory);
    return o;
  }
  /* accessor methods */
  public java.math.BigDecimal getMedLkupSk() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(0); }

  public void setMedLkupSk(java.math.BigDecimal medLkupSk) throws SQLException
  { _struct.setAttribute(0, medLkupSk); }
  ...
  { _struct.setAttribute(10, medNdcCode); }
  ...
  { _struct.setAttribute(11, medGenericName); }
  ...
  { _struct.setAttribute(12, medPtyName); }
  ...
  { _struct.setAttribute(13, medInnName); }
  ...
  { _struct.setAttribute(14, medChemicalName); }
  ...
  { _struct.setAttribute(15, medClasName); }
  ...
  { _struct.setAttribute(16, medMfgCode); }
  ...
  { _struct.setAttribute(17, medMfgName); }
  ...
  { _struct.setAttribute(18, medPackageDesc); }
  ...
  { _struct.setAttribute(19, medNcpdpUomCode); }
  ...
  { _struct.setAttribute(20, medDesc); }
