...
public class BeStaffTrngLkupT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "COREDATA.BE_STAFF_TRNG_LKUP_T";
  ...
  protected static final BeStaffTrngLkupT _BeStaffTrngLkupTFactory = new BeStaffTrngLkupT();

  public static ORADataFactory getORADataFactory()
  { return _BeStaffTrngLkupTFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[18], _sqlType, _factory); }
  public BeStaffTrngLkupT()
  { _init_struct(true); }
  public BeStaffTrngLkupT(java.math.BigDecimal beStaffTrngLkupSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, java.sql.Timestamp recEffTmstp, java.sql.Timestamp recTermTmstp, String recCreatedBy, String recUpdatedBy, String changeReasonMemo, java.math.BigDecimal currRecInd, java.math.BigDecimal changeVersionId, String beId, String staffTrngCode, String staffTrngName, String staffTrngDesc, String staffTrngQlfr, java.math.BigDecimal staffTrngMandInd, java.math.BigDecimal staffTrngTotalHrs, String staffTrngNotes) throws SQLException
  { _init_struct(true);
  ...
  protected ORAData create(BeStaffTrngLkupT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new BeStaffTrngLkupT();
