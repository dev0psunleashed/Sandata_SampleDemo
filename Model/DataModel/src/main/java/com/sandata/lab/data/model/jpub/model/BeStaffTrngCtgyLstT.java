...
public class BeStaffTrngCtgyLstT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "COREDATA.BE_STAFF_TRNG_CTGY_LST_T";
  ...
  protected static final BeStaffTrngCtgyLstT _BeStaffTrngCtgyLstTFactory = new BeStaffTrngCtgyLstT();

  public static ORADataFactory getORADataFactory()
  { return _BeStaffTrngCtgyLstTFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[14], _sqlType, _factory); }
  public BeStaffTrngCtgyLstT()
  { _init_struct(true); }
  public BeStaffTrngCtgyLstT(java.math.BigDecimal beStaffTrngCtgyLstSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, java.sql.Timestamp recEffTmstp, java.sql.Timestamp recTermTmstp, String recCreatedBy, String recUpdatedBy, String changeReasonMemo, java.math.BigDecimal currRecInd, java.math.BigDecimal changeVersionId, String beId, String staffTrngCtgyCode, String staffTrngCode, String staffTrngQlfr) throws SQLException
  { _init_struct(true);
    setBeStaffTrngCtgyLstSk(beStaffTrngCtgyLstSk);
  ...
  protected ORAData create(BeStaffTrngCtgyLstT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new BeStaffTrngCtgyLstT();
    o._struct = new MutableStruct((STRUCT) d, _sqlType, _factory);
    return o;
  }
  /* accessor methods */
  public java.math.BigDecimal getBeStaffTrngCtgyLstSk() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(0); }

  public void setBeStaffTrngCtgyLstSk(java.math.BigDecimal beStaffTrngCtgyLstSk) throws SQLException
  { _struct.setAttribute(0, beStaffTrngCtgyLstSk); }
