 ...
 *       &lt;attribute name="Patient_Payer_Frequency_Type_Name" use="required" type="{}Frequency_Type_Name" />
...
public class PatientPayer extends BaseObject {
    ...
    @XmlAttribute(name = "Patient_Payer_Frequency_Type_Name", required = true)
