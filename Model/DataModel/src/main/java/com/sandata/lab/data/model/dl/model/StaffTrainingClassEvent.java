...
/**
 * <p>Java class for Staff_Training_Class_Event complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Staff_Training_Class_Event">
 *   &lt;complexContent>
 ...
 *       &lt;/sequence>
 *       &lt;attribute name="Staff_Training_Class_Event_SK" use="required" type="{}Surrogate_Key" />
 ...
 *       &lt;attribute name="Staff_Training_Max_Attendance" type="{http://www.w3.org/2001/XMLSchema}integer" />
 *       &lt;attribute name="Staff_Training_Instructor_First_Name" type="{}Name" />
 *       &lt;attribute name="Staff_Training_Instructor_Last_Name" type="{}Name" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "Staff_Training_Class_Event", propOrder = {
...
@OracleMetadata(
        ...
        insertMethod = "insertStaffTrngClsEvnt",
        updateMethod = "updateStaffTrngClsEvnt",
        deleteMethod = "deleteStaffTrngClsEvnt",
        getMethod = "getStaffTrngClsEvnt",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.StaffTrngClsEvntT",
        primaryKeys = {})
public class StaffTrainingClassEvent extends BaseObject {
    ...
    @XmlAttribute(name = "Staff_Training_Class_Event_SK", required = true)
    @SerializedName("StaffTrainingClassEventSK")
	@Mapping(getter = "getStaffTrngClsEvntSk", setter = "setStaffTrngClsEvntSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger staffTrainingClassEventSK;
	...
	@Mapping(getter = "getStaffTrngQlfr", setter = "setStaffTrngQlfr", type = "String", index = 13)
	...
	@Mapping(getter = "getStaffTrngStartDtime", setter = "setStaffTrngStartDtime", type = "java.sql.Timestamp", index = 14)
    protected Date staffTrainingStartDatetime;
    @XmlAttribute(name = "Staff_Training_Max_Attendance")
    @SerializedName("StaffTrainingMaxAttendance")
	@Mapping(getter = "getStaffTrngMaxAttnd", setter = "setStaffTrngMaxAttnd", type = "java.math.BigDecimal", index = 15)
    protected BigInteger staffTrainingMaxAttendance;
    @XmlAttribute(name = "Staff_Training_Instructor_First_Name")
    @SerializedName("StaffTrainingInstructorFirstName")
	@Mapping(getter = "getStaffTrngInstrFirstName", setter = "setStaffTrngInstrFirstName", type = "String", index = 16)
    protected String staffTrainingInstructorFirstName;
    @XmlAttribute(name = "Staff_Training_Instructor_Last_Name")
    @SerializedName("StaffTrainingInstructorLastName")
	@Mapping(getter = "getStaffTrngInstrLastName", setter = "setStaffTrngInstrLastName", type = "String", index = 17)
    protected String staffTrainingInstructorLastName;
    ...
    /**
     * Gets the value of the staffTrainingClassEventSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getStaffTrainingClassEventSK() {
        return staffTrainingClassEventSK;
    }

    /**
     * Sets the value of the staffTrainingClassEventSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setStaffTrainingClassEventSK(BigInteger value) {
        this.staffTrainingClassEventSK = value;
    }
    ...
    /**
     * Gets the value of the staffTrainingMaxAttendance property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getStaffTrainingMaxAttendance() {
        return staffTrainingMaxAttendance;
    }

    /**
     * Sets the value of the staffTrainingMaxAttendance property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setStaffTrainingMaxAttendance(BigInteger value) {
        this.staffTrainingMaxAttendance = value;
    }

    /**
     * Gets the value of the staffTrainingInstructorFirstName property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getStaffTrainingInstructorFirstName() {
        return staffTrainingInstructorFirstName;
    }

    /**
     * Sets the value of the staffTrainingInstructorFirstName property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setStaffTrainingInstructorFirstName(String value) {
        this.staffTrainingInstructorFirstName = value;
    }

    /**
     * Gets the value of the staffTrainingInstructorLastName property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getStaffTrainingInstructorLastName() {
        return staffTrainingInstructorLastName;
    }

    /**
     * Sets the value of the staffTrainingInstructorLastName property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setStaffTrainingInstructorLastName(String value) {
        this.staffTrainingInstructorLastName = value;
    }
