...
/**
 * <p>Java class for Nutritional_Requirement_Lookup complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Nutritional_Requirement_Lookup">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;attribute name="Nutritional_Requirement_Lookup_SK" use="required" type="{}Surrogate_Key" />
...
@XmlType(name = "Nutritional_Requirement_Lookup")
@OracleMetadata(
        packageName = "PKG_LOOKUP",
        insertMethod = "insertNutrRqmtLkup",
        updateMethod = "updateNutrRqmtLkup",
        deleteMethod = "deleteNutrRqmtLkup",
        getMethod = "getNutrRqmtLkup",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.NutrRqmtLkupT",
        primaryKeys = {})
public class NutritionalRequirementLookup extends BaseObject {

	private static final long serialVersionUID = 1L;

    @XmlAttribute(name = "Nutritional_Requirement_Lookup_SK", required = true)
    @SerializedName("NutritionalRequirementLookupSK")
	@Mapping(getter = "getNutrRqmtLkupSk", setter = "setNutrRqmtLkupSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger nutritionalRequirementLookupSK;
	...
	@Mapping(getter = "getNutrRqmtName", setter = "setNutrRqmtName", type = "String", index = 10)
	...
	@Mapping(getter = "getNutrRqmtDesc", setter = "setNutrRqmtDesc", type = "String", index = 11)
    protected String nutritionalRequirementDescription;

    /**
     * Gets the value of the nutritionalRequirementLookupSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getNutritionalRequirementLookupSK() {
        return nutritionalRequirementLookupSK;
    }

    /**
     * Sets the value of the nutritionalRequirementLookupSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setNutritionalRequirementLookupSK(BigInteger value) {
        this.nutritionalRequirementLookupSK = value;
    }
