...
/**
 * <p>Java class for Staff_Compliance_Summary complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Staff_Compliance_Summary">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;attribute name="Staff_Compliance_Summary_SK" use="required" type="{}Surrogate_Key" />
 ...
 *       &lt;attribute name="Compliance_Indicator" use="required" type="{}Indicator" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "Staff_Compliance_Summary")
@OracleMetadata(
        packageName = "PKG_STAFF",
        insertMethod = "insertStaffCompSummary",
        updateMethod = "updateStaffCompSummary",
        deleteMethod = "deleteStaffCompSummary",
        getMethod = "getStaffCompSummary",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.StaffCompSummaryT",
        primaryKeys = {})
public class StaffComplianceSummary extends BaseObject {

	private static final long serialVersionUID = 1L;

    @XmlAttribute(name = "Staff_Compliance_Summary_SK", required = true)
    @SerializedName("StaffComplianceSummarySK")
	@Mapping(getter = "getStaffCompSummarySk", setter = "setStaffCompSummarySk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger staffComplianceSummarySK;
	...
	@Mapping(getter = "getStaffCompExprDate", setter = "setStaffCompExprDate", type = "java.sql.Timestamp", index = 12)
    ...
    @XmlSchemaType(name = "dateTime")
	@Mapping(getter = "getStaffCompRcvdDate", setter = "setStaffCompRcvdDate", type = "java.sql.Timestamp", index = 13)
    protected Date staffComplianceReceivedDate;
    @XmlAttribute(name = "Compliance_Indicator", required = true)
    @SerializedName("ComplianceIndicator")
	@Mapping(getter = "getCompInd", setter = "setCompInd", type = "java.math.BigDecimal", index = 14)
    protected boolean complianceIndicator;

    /**
     * Gets the value of the staffComplianceSummarySK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getStaffComplianceSummarySK() {
        return staffComplianceSummarySK;
    }

    /**
     * Sets the value of the staffComplianceSummarySK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setStaffComplianceSummarySK(BigInteger value) {
        this.staffComplianceSummarySK = value;
    }
     ...
     * 
     */
    public boolean isComplianceIndicator() {
     ...
     * 
     */
    public void setComplianceIndicator(boolean value) {
