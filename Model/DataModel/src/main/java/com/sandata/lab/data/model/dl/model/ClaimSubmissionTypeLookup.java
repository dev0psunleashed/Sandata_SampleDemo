 ...
 * 
 * <p>Java class for Claim_Submission_Type_Lookup complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Claim_Submission_Type_Lookup">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element ref="{}Claim" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attribute name="Claim_Submission_Type_Lookup_SK" use="required" type="{}Surrogate_Key" />
 ...
 *       &lt;attribute name="Claim_Submission_Type_Name" use="required" type="{}Claim_Submission_Type_Name" />
 *       &lt;attribute name="Claim_Submission_Type_Description" type="{}Comment_Short" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "Claim_Submission_Type_Lookup", propOrder = {
    "claim"
})
@OracleMetadata(
        packageName = "PKG_LOOKUP",
        insertMethod = "insertClaimSubmTypLkup",
        updateMethod = "updateClaimSubmTypLkup",
        deleteMethod = "deleteClaimSubmTypLkup",
        getMethod = "getClaimSubmTypLkup",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.ClaimSubmTypLkupT",
        primaryKeys = {})
public class ClaimSubmissionTypeLookup extends BaseObject {
    ...
    @XmlAttribute(name = "Claim_Submission_Type_Lookup_SK", required = true)
    @SerializedName("ClaimSubmissionTypeLookupSK")
	@Mapping(getter = "getClaimSubmTypLkupSk", setter = "setClaimSubmTypLkupSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger claimSubmissionTypeLookupSK;
    ...
    @XmlAttribute(name = "Claim_Submission_Type_Name", required = true)
    @SerializedName("ClaimSubmissionTypeName")
	@Mapping(getter = "getClaimSubmTypName", setter = "setClaimSubmTypName", type = "String", index = 10)
    protected ClaimSubmissionTypeName claimSubmissionTypeName;
    @XmlAttribute(name = "Claim_Submission_Type_Description")
    @SerializedName("ClaimSubmissionTypeDescription")
	@Mapping(getter = "getClaimSubmTypDesc", setter = "setClaimSubmTypDesc", type = "String", index = 11)
    protected String claimSubmissionTypeDescription;
    ...
    /**
     * Gets the value of the claimSubmissionTypeLookupSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getClaimSubmissionTypeLookupSK() {
        return claimSubmissionTypeLookupSK;
    }

    /**
     * Sets the value of the claimSubmissionTypeLookupSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setClaimSubmissionTypeLookupSK(BigInteger value) {
        this.claimSubmissionTypeLookupSK = value;
    }
    ...
    /**
     * Gets the value of the claimSubmissionTypeName property.
     * 
     * @return
     *     possible object is
     *     {@link ClaimSubmissionTypeName }
     *     
     */
    public ClaimSubmissionTypeName getClaimSubmissionTypeName() {
        return claimSubmissionTypeName;
    }

    /**
     * Sets the value of the claimSubmissionTypeName property.
     * 
     * @param value
     *     allowed object is
     *     {@link ClaimSubmissionTypeName }
     *     
     */
    public void setClaimSubmissionTypeName(ClaimSubmissionTypeName value) {
        this.claimSubmissionTypeName = value;
    }

    /**
     * Gets the value of the claimSubmissionTypeDescription property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getClaimSubmissionTypeDescription() {
        return claimSubmissionTypeDescription;
    }

    /**
     * Sets the value of the claimSubmissionTypeDescription property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setClaimSubmissionTypeDescription(String value) {
        this.claimSubmissionTypeDescription = value;
    }
