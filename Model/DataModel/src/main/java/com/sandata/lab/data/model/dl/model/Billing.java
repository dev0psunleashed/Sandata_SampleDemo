 ...
 *       &lt;sequence>
 *         &lt;element ref="{}Billing_History" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *       &lt;attribute name="Billing_Total_Amount" use="required" type="{}Money" />
...
@OracleMetadata(
        ...
        insertMethod = "insertBilling",
        updateMethod = "updateBilling",
        deleteMethod = "deleteBilling",
        getMethod = "getBilling",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.BillingT",
        primaryKeys = {})
public class Billing extends BaseObject {

	private static final long serialVersionUID = 1L;

    @XmlElement(name = "Billing_History")
    @SerializedName("BillingHistory")
    protected List<BillingHistory> billingHistory;
	...
	@Mapping(getter = "getBillingSk", setter = "setBillingSk", type = "java.math.BigDecimal", index = 0)
	...
	@Mapping(getter = "getBeLobId", setter = "setBeLobId", type = "String", index = 9)
	...
	@Mapping(getter = "getAuthId", setter = "setAuthId", type = "String", index = 13)
	...
	@Mapping(getter = "getPtInsIdNum", setter = "setPtInsIdNum", type = "String", index = 15)
    protected String patientInsuranceIDNumber;
    @XmlAttribute(name = "Billing_Status_Name")
    @SerializedName("BillingStatusName")
	@Mapping(getter = "getBillingStatusName", setter = "setBillingStatusName", type = "String", index = 16)
    protected String billingStatusName;
    @XmlAttribute(name = "Billing_Submission_Type_Name")
    @SerializedName("BillingSubmissionTypeName")
	@Mapping(getter = "getBillingSubmTypName", setter = "setBillingSubmTypName", type = "String", index = 17)
    ...
    @XmlJavaTypeAdapter(com.sandata.lab.data.model.Adapter1.class)
	@Mapping(getter = "getBillingStartDate", setter = "setBillingStartDate", type = "java.sql.Timestamp", index = 18)
    protected Date billingStartDate;
    @XmlAttribute(name = "Billing_End_Date", required = true)
    @SerializedName("BillingEndDate")
    @XmlJavaTypeAdapter(Adapter1.class)
	@Mapping(getter = "getBillingEndDate", setter = "setBillingEndDate", type = "java.sql.Timestamp", index = 19)
    protected Date billingEndDate;
    @XmlAttribute(name = "Billing_Date")
    @SerializedName("BillingDate")
    @XmlJavaTypeAdapter(Adapter2.class)
    @XmlSchemaType(name = "date")
	@Mapping(getter = "getBillingDate", setter = "setBillingDate", type = "java.sql.Timestamp", index = 20)
    protected Date billingDate;
    @XmlAttribute(name = "Billing_Type_Qualifier")
    @SerializedName("BillingTypeQualifier")
	@Mapping(getter = "getBillingTypQlfr", setter = "setBillingTypQlfr", type = "String", index = 21)
	...
	@Mapping(getter = "getBillingFmtTypName", setter = "setBillingFmtTypName", type = "String", index = 22)
    protected String billingFormatTypeName;
    @XmlAttribute(name = "ICD_Diagnosis_Code_Primary")
    @SerializedName("ICDDiagnosisCodePrimary")
	@Mapping(getter = "getIcdDxCodePrmy", setter = "setIcdDxCodePrmy", type = "String", index = 23)
	...
	@Mapping(getter = "getIcdDxCodeRevisionQlfrPrmy", setter = "setIcdDxCodeRevisionQlfrPrmy", type = "String", index = 24)
	...
	@Mapping(getter = "getIcdDxCode2", setter = "setIcdDxCode2", type = "String", index = 25)
	...
	@Mapping(getter = "getIcdDxCodeRevisionQlfr2", setter = "setIcdDxCodeRevisionQlfr2", type = "String", index = 26)
	...
	@Mapping(getter = "getIcdDxCode3", setter = "setIcdDxCode3", type = "String", index = 27)
	...
	@Mapping(getter = "getIcdDxCodeRevisionQlfr3", setter = "setIcdDxCodeRevisionQlfr3", type = "String", index = 28)
	...
	@Mapping(getter = "getIcdDxCode4", setter = "setIcdDxCode4", type = "String", index = 29)
	...
	@Mapping(getter = "getIcdDxCodeRevisionQlfr4", setter = "setIcdDxCodeRevisionQlfr4", type = "String", index = 30)
	...
	@Mapping(getter = "getIcdDxCode5", setter = "setIcdDxCode5", type = "String", index = 31)
	...
	@Mapping(getter = "getIcdDxCodeRevisionQlfr5", setter = "setIcdDxCodeRevisionQlfr5", type = "String", index = 32)
	...
	@Mapping(getter = "getIcdDxCodeRevisionQlfr6", setter = "setIcdDxCodeRevisionQlfr6", type = "String", index = 34)
	...
	@Mapping(getter = "getIcdDxCode7", setter = "setIcdDxCode7", type = "String", index = 35)
	...
	@Mapping(getter = "getIcdDxCodeRevisionQlfr7", setter = "setIcdDxCodeRevisionQlfr7", type = "String", index = 36)
	...
	@Mapping(getter = "getIcdDxCode8", setter = "setIcdDxCode8", type = "String", index = 37)
	...
	@Mapping(getter = "getIcdDxCodeRevisionQlfr8", setter = "setIcdDxCodeRevisionQlfr8", type = "String", index = 38)
	...
	@Mapping(getter = "getIcdDxCodeRevisionQlfr9", setter = "setIcdDxCodeRevisionQlfr9", type = "String", index = 40)
	...
	@Mapping(getter = "getIcdDxCode10", setter = "setIcdDxCode10", type = "String", index = 41)
	...
	@Mapping(getter = "getIcdDxCodeRevisionQlfr10", setter = "setIcdDxCodeRevisionQlfr10", type = "String", index = 42)
	...
	@Mapping(getter = "getIcdDxCode11", setter = "setIcdDxCode11", type = "String", index = 43)
	...
	@Mapping(getter = "getIcdDxCodeRevisionQlfr11", setter = "setIcdDxCodeRevisionQlfr11", type = "String", index = 44)
	...
	@Mapping(getter = "getIcdDxCodeRevisionQlfr12", setter = "setIcdDxCodeRevisionQlfr12", type = "String", index = 46)
	...
	@Mapping(getter = "getRenderHcpNpi", setter = "setRenderHcpNpi", type = "String", index = 47)
	...
	@Mapping(getter = "getRefingHcpNpi", setter = "setRefingHcpNpi", type = "String", index = 48)
    protected String referringHealthcareProfessionalNationalProviderIdentifier;
    @XmlAttribute(name = "Billing_Total_Amount", required = true)
    @SerializedName("BillingTotalAmount")
	@Mapping(getter = "getBillingTotalAmt", setter = "setBillingTotalAmt", type = "java.math.BigDecimal", index = 49)
    protected BigDecimal billingTotalAmount;
    @XmlAttribute(name = "Billing_Total_Unit")
    @SerializedName("BillingTotalUnit")
	@Mapping(getter = "getBillingTotalUnit", setter = "setBillingTotalUnit", type = "java.math.BigDecimal", index = 50)
    protected BigDecimal billingTotalUnit;
    @XmlAttribute(name = "Billing_Bill_Type_Code")
    @SerializedName("BillingBillTypeCode")
	@Mapping(getter = "getBillingBillTypCode", setter = "setBillingBillTypCode", type = "String", index = 51)
	...
	@Mapping(getter = "getBillingManualOverrideInd", setter = "setBillingManualOverrideInd", type = "java.math.BigDecimal", index = 52)
    protected Boolean billingManuallyOverrideIndicator;
    @XmlAttribute(name = "User_Name")
    @SerializedName("UserName")
	@Mapping(getter = "getUserName", setter = "setUserName", type = "String", index = 53)
    protected String userName;
    @XmlAttribute(name = "User_Globally_Unique_Identifier")
    @SerializedName("UserGloballyUniqueIdentifier")
	@Mapping(getter = "getUserGuid", setter = "setUserGuid", type = "String", index = 54)
    protected String userGloballyUniqueIdentifier;
    @XmlAttribute(name = "Memo")
    @SerializedName("Memo")
	@Mapping(getter = "getMemo", setter = "setMemo", type = "String", index = 55)
    ...
    /**
     * Gets the value of the billingHistory property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the billingHistory property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBillingHistory().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<BillingHistory> getBillingHistory() {
        if (billingHistory == null) {
            billingHistory = new ArrayList<BillingHistory>();
        }
