...
public class PayerMdfrLkupT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "COREDATA.PAYER_MDFR_LKUP_T";
  ...
  protected static final PayerMdfrLkupT __PAYER_MDFR_LKUP_T_FACTORY = new PayerMdfrLkupT();

  public static ORADataFactory getORADataFactory()
  { return __PAYER_MDFR_LKUP_T_FACTORY; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[17], _sqlType, _factory); }
  public PayerMdfrLkupT()
  { _init_struct(true); }
  public PayerMdfrLkupT(java.math.BigDecimal payerMdfrLstSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, java.sql.Timestamp recEffTmstp, java.sql.Timestamp recTermTmstp, String recCreatedBy, String recUpdatedBy, String changeReasonMemo, java.math.BigDecimal currRecInd, java.math.BigDecimal changeVersionId, String beId, String payerId, String mdfrCode, String mdfrShortDesc, String mdfrLongDesc, java.sql.Timestamp mdfrEffDate, java.sql.Timestamp mdfrTermDate) throws SQLException
  { _init_struct(true);
    setPayerMdfrLstSk(payerMdfrLstSk);
  ...
  protected ORAData create(PayerMdfrLkupT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new PayerMdfrLkupT();
    o._struct = new MutableStruct((STRUCT) d, _sqlType, _factory);
    return o;
  }
  /* accessor methods */
  public java.math.BigDecimal getPayerMdfrLstSk() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(0); }

  public void setPayerMdfrLstSk(java.math.BigDecimal payerMdfrLstSk) throws SQLException
  { _struct.setAttribute(0, payerMdfrLstSk); }
  ...
  { _struct.setAttribute(12, mdfrCode); }
  ...
  { _struct.setAttribute(13, mdfrShortDesc); }
  ...
  { _struct.setAttribute(14, mdfrLongDesc); }
  ...
  { _struct.setAttribute(15, mdfrEffDate); }

  public java.sql.Timestamp sgtMdfrTermDate() throws SQLException
  ...
  { _struct.setAttribute(16, mdfrTermDate); }
}
