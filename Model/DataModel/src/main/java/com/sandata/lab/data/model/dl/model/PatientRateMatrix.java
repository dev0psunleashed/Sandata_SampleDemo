 ...
 * 
 * <p>Java class for Patient_Rate_Matrix complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Patient_Rate_Matrix">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;attribute name="Patient_Rate_Matrix_SK" use="required" type="{}Surrogate_Key" />
 ...
 *       &lt;attribute name="Patient_Rate_Effective_Date" use="required" type="{http://www.w3.org/2001/XMLSchema}dateTime" />
 *       &lt;attribute name="Patient_Rate_Terminaton_Date" use="required" type="{http://www.w3.org/2001/XMLSchema}dateTime" />
 *       &lt;attribute name="Patient_Rate_Amount" use="required" type="{}Money" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "Patient_Rate_Matrix")
@OracleMetadata(
        packageName = "PKG_PATIENT",
        insertMethod = "insertPtRateMatrix",
        updateMethod = "updatePtRateMatrix",
        deleteMethod = "deletePtRateMatrix",
        getMethod = "getPtRateMatrix",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.PtRateMatrixT",
        primaryKeys = {})
public class PatientRateMatrix extends BaseObject {

	private static final long serialVersionUID = 1L;

    @XmlAttribute(name = "Patient_Rate_Matrix_SK", required = true)
    @SerializedName("PatientRateMatrixSK")
	@Mapping(getter = "getPtRateMatrixSk", setter = "setPtRateMatrixSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger patientRateMatrixSK;
    ...
    @XmlAttribute(name = "Patient_Rate_Effective_Date", required = true)
    @SerializedName("PatientRateEffectiveDate")
    @XmlJavaTypeAdapter(com.sandata.lab.data.model.Adapter1.class)
    @XmlSchemaType(name = "dateTime")
	@Mapping(getter = "getPtRateEffDate", setter = "setPtRateEffDate", type = "java.sql.Timestamp", index = 15)
    protected Date patientRateEffectiveDate;
    @XmlAttribute(name = "Patient_Rate_Terminaton_Date", required = true)
    @SerializedName("PatientRateTerminatonDate")
    @XmlJavaTypeAdapter(Adapter1.class)
    @XmlSchemaType(name = "dateTime")
	@Mapping(getter = "getPtRateTerminatonDate", setter = "setPtRateTerminatonDate", type = "java.sql.Timestamp", index = 16)
    protected Date patientRateTerminatonDate;
    @XmlAttribute(name = "Patient_Rate_Amount", required = true)
    @SerializedName("PatientRateAmount")
	@Mapping(getter = "getPtRateAmt", setter = "setPtRateAmt", type = "java.math.BigDecimal", index = 17)
    protected BigDecimal patientRateAmount;

    /**
     * Gets the value of the patientRateMatrixSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getPatientRateMatrixSK() {
        return patientRateMatrixSK;
    }

    /**
     * Sets the value of the patientRateMatrixSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setPatientRateMatrixSK(BigInteger value) {
        this.patientRateMatrixSK = value;
    }
    ...
    /**
     * Gets the value of the patientRateEffectiveDate property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public Date getPatientRateEffectiveDate() {
        return patientRateEffectiveDate;
    }

    /**
     * Sets the value of the patientRateEffectiveDate property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setPatientRateEffectiveDate(Date value) {
        this.patientRateEffectiveDate = value;
    }

    /**
     * Gets the value of the patientRateTerminatonDate property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public Date getPatientRateTerminatonDate() {
        return patientRateTerminatonDate;
    }

    /**
     * Sets the value of the patientRateTerminatonDate property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setPatientRateTerminatonDate(Date value) {
        this.patientRateTerminatonDate = value;
    }
