 ...
 * 
 * <p>Java class for Patient_Contact_Email complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Patient_Contact_Email">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;attribute name="Patient_Contact_Email_SK" use="required" type="{}Surrogate_Key" />
 ...
 *       &lt;attribute name="Patient_Contact_Email_Qualifier" type="{}Name_Generic" />
 *       &lt;attribute name="Patient_Email" type="{}Email" />
 *       &lt;attribute name="Patient_Email_Primary_Indicator" type="{}Indicator" />
 *       &lt;attribute name="Patient_Email_HTML_Indicator" type="{}Indicator" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "Patient_Contact_Email")
@OracleMetadata(
        packageName = "PKG_PATIENT",
        insertMethod = "insertPtContEmail",
        updateMethod = "updatePtContEmail",
        deleteMethod = "deletePtContEmail",
        getMethod = "getPtContEmail",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.PtContEmailT",
        primaryKeys = {})
public class PatientContactEmail extends BaseObject {

	private static final long serialVersionUID = 1L;

    @XmlAttribute(name = "Patient_Contact_Email_SK", required = true)
    @SerializedName("PatientContactEmailSK")
	@Mapping(getter = "getPtContEmailSk", setter = "setPtContEmailSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger patientContactEmailSK;
    ...
    @XmlAttribute(name = "Patient_Contact_Email_Qualifier")
    @SerializedName("PatientContactEmailQualifier")
	@Mapping(getter = "getPtContEmailQlfr", setter = "setPtContEmailQlfr", type = "String", index = 12)
    protected String patientContactEmailQualifier;
    @XmlAttribute(name = "Patient_Email")
    @SerializedName("PatientEmail")
	@Mapping(getter = "getPtEmail", setter = "setPtEmail", type = "String", index = 13)
    protected String patientEmail;
    @XmlAttribute(name = "Patient_Email_Primary_Indicator")
    @SerializedName("PatientEmailPrimaryIndicator")
	@Mapping(getter = "getPtEmailPrmyInd", setter = "setPtEmailPrmyInd", type = "java.math.BigDecimal", index = 14)
    protected Boolean patientEmailPrimaryIndicator;
    @XmlAttribute(name = "Patient_Email_HTML_Indicator")
    @SerializedName("PatientEmailHTMLIndicator")
	@Mapping(getter = "getPtEmailHtmlInd", setter = "setPtEmailHtmlInd", type = "java.math.BigDecimal", index = 15)
    protected Boolean patientEmailHTMLIndicator;

    /**
     * Gets the value of the patientContactEmailSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getPatientContactEmailSK() {
        return patientContactEmailSK;
    }

    /**
     * Sets the value of the patientContactEmailSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setPatientContactEmailSK(BigInteger value) {
        this.patientContactEmailSK = value;
    }
    ...
    /**
     * Gets the value of the patientContactEmailQualifier property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getPatientContactEmailQualifier() {
        return patientContactEmailQualifier;
    }

    /**
     * Sets the value of the patientContactEmailQualifier property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setPatientContactEmailQualifier(String value) {
        this.patientContactEmailQualifier = value;
    }
    ...
    /**
     * Gets the value of the patientEmailPrimaryIndicator property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isPatientEmailPrimaryIndicator() {
        return patientEmailPrimaryIndicator;
    }

    /**
     * Sets the value of the patientEmailPrimaryIndicator property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setPatientEmailPrimaryIndicator(Boolean value) {
        this.patientEmailPrimaryIndicator = value;
    }

    /**
     * Gets the value of the patientEmailHTMLIndicator property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isPatientEmailHTMLIndicator() {
        return patientEmailHTMLIndicator;
    }

    /**
     * Sets the value of the patientEmailHTMLIndicator property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setPatientEmailHTMLIndicator(Boolean value) {
        this.patientEmailHTMLIndicator = value;
    }
