...
@XmlType(name = "Schedule_Event_Service")
@OracleMetadata(
        packageName = "PKG_SCHEDULE",
        insertMethod = "insertSchedEvntSvc",
        updateMethod = "updateSchedEvntSvc",
        deleteMethod = "deleteSchedEvntSvc",
        getMethod = "getSchedEvntSvc",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.SchedEvntSvcT",
        primaryKeys = {})
public class ScheduleEventService extends BaseObject {

	private static final long serialVersionUID = 1L;

    @XmlAttribute(name = "Schedule_Event_Service_SK", required = true)
    @SerializedName("ScheduleEventServiceSK")
	@Mapping(getter = "getSchedEvntSvcSk", setter = "setSchedEvntSvcSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger scheduleEventServiceSK;
	...
	@Mapping(getter = "getSchedEvntSk", setter = "setSchedEvntSk", type = "java.math.BigDecimal", index = 10)
    protected BigInteger scheduleEventSK;
    @XmlAttribute(name = "Service_SK", required = true)
    @SerializedName("ServiceSK")
	@Mapping(getter = "getSvcSk", setter = "setSvcSk", type = "java.math.BigDecimal", index = 11)
    protected BigInteger serviceSK;

    /**
     * Gets the value of the scheduleEventServiceSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getScheduleEventServiceSK() {
        return scheduleEventServiceSK;
    }

    /**
     * Sets the value of the scheduleEventServiceSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setScheduleEventServiceSK(BigInteger value) {
        this.scheduleEventServiceSK = value;
    }
