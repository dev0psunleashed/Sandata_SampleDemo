...
public class PtContAddrT implements ORAData, ORADataFactory
{
  ...
  protected static int[] _sqlType =  { 2,91,91,91,91,12,12,2,12,2,12,12,12,12,2,12,12,12,12,1,12,12,12,12,12,2,2,2,91,2 };
  ...
  { _init_struct(true);
    ...
    setPtAddrPositionTrkInd(ptAddrPositionTrkInd);
  }
  ...
  public java.math.BigDecimal getPtAddrPositionTrkInd() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(29); }

  public void setPtAddrPositionTrkInd(java.math.BigDecimal ptAddrPositionTrkInd) throws SQLException
  { _struct.setAttribute(29, ptAddrPositionTrkInd); }
