...
/**
 * Information pertaining to the various  required compliance activities that the Staff member is required to complete
 * 
 * <p>Java class for Staff_Compliance complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Staff_Compliance">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;attribute name="Staff_Compliance_SK" use="required" type="{}Surrogate_Key" />
 ...
 *       &lt;attribute name="Compliance_Reading_Value" type="{}Reading_Value" />
 *       &lt;attribute name="Staff_Compliance_Received_Date" type="{http://www.w3.org/2001/XMLSchema}dateTime" />
 *       &lt;attribute name="Staff_Compliance_Expiration_Date" type="{http://www.w3.org/2001/XMLSchema}dateTime" />
 *       &lt;attribute name="Staff_Compliance_Note" type="{}Comment_Long" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "Staff_Compliance")
@OracleMetadata(
        packageName = "PKG_STAFF",
        insertMethod = "insertStaffComp",
        updateMethod = "updateStaffComp",
        deleteMethod = "deleteStaffComp",
        getMethod = "getStaffComp",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.StaffCompT",
        primaryKeys = {})
public class StaffCompliance extends BaseObject {

	private static final long serialVersionUID = 1L;

    @XmlAttribute(name = "Staff_Compliance_SK", required = true)
    @SerializedName("StaffComplianceSK")
	@Mapping(getter = "getStaffCompSk", setter = "setStaffCompSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger staffComplianceSK;
	...
	@Mapping(getter = "getCompCode", setter = "setCompCode", type = "String", index = 12)
    protected String complianceCode;
    @XmlAttribute(name = "Compliance_Reading_Value")
    @SerializedName("ComplianceReadingValue")
	@Mapping(getter = "getCompRdngVal", setter = "setCompRdngVal", type = "String", index = 13)
    protected String complianceReadingValue;
    @XmlAttribute(name = "Staff_Compliance_Received_Date")
    @SerializedName("StaffComplianceReceivedDate")
    @XmlJavaTypeAdapter(com.sandata.lab.data.model.Adapter1.class)
    @XmlSchemaType(name = "dateTime")
	@Mapping(getter = "getStaffCompRcvdDate", setter = "setStaffCompRcvdDate", type = "java.sql.Timestamp", index = 14)
    protected Date staffComplianceReceivedDate;
    @XmlAttribute(name = "Staff_Compliance_Expiration_Date")
    @SerializedName("StaffComplianceExpirationDate")
    @XmlJavaTypeAdapter(Adapter1.class)
    @XmlSchemaType(name = "dateTime")
	@Mapping(getter = "getStaffCompExprDate", setter = "setStaffCompExprDate", type = "java.sql.Timestamp", index = 15)
    protected Date staffComplianceExpirationDate;
    @XmlAttribute(name = "Staff_Compliance_Note")
    @SerializedName("StaffComplianceNote")
	@Mapping(getter = "getStaffCompNote", setter = "setStaffCompNote", type = "String", index = 16)
    protected String staffComplianceNote;

    /**
     * Gets the value of the staffComplianceSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getStaffComplianceSK() {
        return staffComplianceSK;
    }

    /**
     * Sets the value of the staffComplianceSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setStaffComplianceSK(BigInteger value) {
        this.staffComplianceSK = value;
    }
    ...
    /**
     * Gets the value of the complianceReadingValue property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getComplianceReadingValue() {
        return complianceReadingValue;
    }

    /**
     * Sets the value of the complianceReadingValue property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setComplianceReadingValue(String value) {
        this.complianceReadingValue = value;
    }

    /**
     * Gets the value of the staffComplianceReceivedDate property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public Date getStaffComplianceReceivedDate() {
        return staffComplianceReceivedDate;
    }

    /**
     * Sets the value of the staffComplianceReceivedDate property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setStaffComplianceReceivedDate(Date value) {
        this.staffComplianceReceivedDate = value;
    }

    /**
     * Gets the value of the staffComplianceExpirationDate property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public Date getStaffComplianceExpirationDate() {
        return staffComplianceExpirationDate;
    }

    /**
     * Sets the value of the staffComplianceExpirationDate property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setStaffComplianceExpirationDate(Date value) {
        this.staffComplianceExpirationDate = value;
    }

    /**
     * Gets the value of the staffComplianceNote property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getStaffComplianceNote() {
        return staffComplianceNote;
    }

    /**
     * Sets the value of the staffComplianceNote property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setStaffComplianceNote(String value) {
        this.staffComplianceNote = value;
    }
