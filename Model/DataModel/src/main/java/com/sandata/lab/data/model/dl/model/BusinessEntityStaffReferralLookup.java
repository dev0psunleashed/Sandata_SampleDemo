 ...
 * 
 * <p>Java class for Business_Entity_Staff_Referral_Lookup complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Business_Entity_Staff_Referral_Lookup">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;attribute name="Business_Entity_Staff_Referral_Lookup_SK" use="required" type="{}Surrogate_Key" />
 ...
 *       &lt;attribute name="Staff_Referral_ID" type="{}ID" />
...
@XmlType(name = "Business_Entity_Staff_Referral_Lookup")
@OracleMetadata(
        packageName = "PKG_AM",
        insertMethod = "insertBeStaffRfrlLkup",
        updateMethod = "updateBeStaffRfrlLkup",
        deleteMethod = "deleteBeStaffRfrlLkup",
        getMethod = "getBeStaffRfrlLkup",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.BeStaffRfrlLkupT",
        primaryKeys = {})
public class BusinessEntityStaffReferralLookup extends BaseObject {

	private static final long serialVersionUID = 1L;

    @XmlAttribute(name = "Business_Entity_Staff_Referral_Lookup_SK", required = true)
    @SerializedName("BusinessEntityStaffReferralLookupSK")
	@Mapping(getter = "getBeStaffRfrlLkupSk", setter = "setBeStaffRfrlLkupSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger businessEntityStaffReferralLookupSK;
    ...
    @XmlAttribute(name = "Staff_Referral_ID")
    @SerializedName("StaffReferralID")
	@Mapping(getter = "getStaffRfrlId", setter = "setStaffRfrlId", type = "String", index = 11)
    protected String staffReferralID;
    @XmlAttribute(name = "Staff_Referral_Type_Name")
    @SerializedName("StaffReferralTypeName")
	@Mapping(getter = "getStaffRfrlTypName", setter = "setStaffRfrlTypName", type = "String", index = 12)
	...
	@Mapping(getter = "getStaffRfrlTypDesc", setter = "setStaffRfrlTypDesc", type = "String", index = 13)
    protected String staffReferralTypeDescription;

    /**
     * Gets the value of the businessEntityStaffReferralLookupSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getBusinessEntityStaffReferralLookupSK() {
        return businessEntityStaffReferralLookupSK;
    }

    /**
     * Sets the value of the businessEntityStaffReferralLookupSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setBusinessEntityStaffReferralLookupSK(BigInteger value) {
        this.businessEntityStaffReferralLookupSK = value;
    }
    ...
    /**
     * Gets the value of the staffReferralID property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getStaffReferralID() {
        return staffReferralID;
    }

    /**
     * Sets the value of the staffReferralID property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setStaffReferralID(String value) {
        this.staffReferralID = value;
    }
