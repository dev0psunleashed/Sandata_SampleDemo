...
/**
 * Lookup table for tax identifier, authority definition and rates
 * 
 * <p>Java class for Business_Entity_Tax_Lookup complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Business_Entity_Tax_Lookup">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;attribute name="Business_Entity_Tax_Lookup_SK" use="required" type="{}Surrogate_Key" />
 ...
 *       &lt;attribute name="Tax_ID" type="{}ID" />
 *       &lt;attribute name="Tax_Type_Name" type="{}Type_Name" />
 *       &lt;attribute name="Tax_Authority_Name" type="{}Name" />
 *       &lt;attribute name="Tax_Rate" type="{}Money" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "Business_Entity_Tax_Lookup")
@OracleMetadata(
        packageName = "PKG_AM",
        insertMethod = "insertBeTaxLkup",
        updateMethod = "updateBeTaxLkup",
        deleteMethod = "deleteBeTaxLkup",
        getMethod = "getBeTaxLkup",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.BeTaxLkupT",
        primaryKeys = {})
public class BusinessEntityTaxLookup extends BaseObject {

	private static final long serialVersionUID = 1L;

    @XmlAttribute(name = "Business_Entity_Tax_Lookup_SK", required = true)
    @SerializedName("BusinessEntityTaxLookupSK")
	@Mapping(getter = "getBeTaxLkupSk", setter = "setBeTaxLkupSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger businessEntityTaxLookupSK;
	...
	@Mapping(getter = "getTaxId", setter = "setTaxId", type = "String", index = 11)
    protected String taxID;
    @XmlAttribute(name = "Tax_Type_Name")
    @SerializedName("TaxTypeName")
	@Mapping(getter = "getTaxTypName", setter = "setTaxTypName", type = "String", index = 12)
    protected String taxTypeName;
    @XmlAttribute(name = "Tax_Authority_Name")
    @SerializedName("TaxAuthorityName")
	@Mapping(getter = "getTaxAuthorityName", setter = "setTaxAuthorityName", type = "String", index = 13)
    protected String taxAuthorityName;
    @XmlAttribute(name = "Tax_Rate")
    @SerializedName("TaxRate")
	@Mapping(getter = "getTaxRate", setter = "setTaxRate", type = "java.math.BigDecimal", index = 14)
    protected BigDecimal taxRate;

    /**
     * Gets the value of the businessEntityTaxLookupSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getBusinessEntityTaxLookupSK() {
        return businessEntityTaxLookupSK;
    }

    /**
     * Sets the value of the businessEntityTaxLookupSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setBusinessEntityTaxLookupSK(BigInteger value) {
        this.businessEntityTaxLookupSK = value;
    }
