...
public class RprtReqT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "METADATA.RPRT_REQ_T";
  public static final int _SQL_TYPECODE = OracleTypes.STRUCT;

  protected MutableStruct _struct;

  protected static int[] _sqlType =  { 2,91,91,12,12,2 };
  protected static ORADataFactory[] _factory = new ORADataFactory[6];
  protected static final RprtReqT _RprtReqTFactory = new RprtReqT();

  public static ORADataFactory getORADataFactory()
  { return _RprtReqTFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[6], _sqlType, _factory); }
  public RprtReqT()
  { _init_struct(true); }
  public RprtReqT(java.math.BigDecimal rprtReqSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, String rprtId, String userGuid, java.math.BigDecimal appSessSk) throws SQLException
  { _init_struct(true);
  ...
  protected ORAData create(RprtReqT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new RprtReqT();
  ...
  { _struct.setAttribute(0, rprtReqSk); }
  ...
  { _struct.setAttribute(5, appSessSk); }
