...
public class AdminStaffRoleXrefT implements ORAData, ORADataFactory
{
  public static final String _SQL_NAME = "COREDATA.ADMIN_STAFF_ROLE_XREF_T";
  ...
  protected static final AdminStaffRoleXrefT _AdminStaffRoleXrefTFactory = new AdminStaffRoleXrefT();

  public static ORADataFactory getORADataFactory()
  { return _AdminStaffRoleXrefTFactory; }
  /* constructors */
  protected void _init_struct(boolean init)
  { if (init) _struct = new MutableStruct(new Object[15], _sqlType, _factory); }
  public AdminStaffRoleXrefT()
  { _init_struct(true); }
  public AdminStaffRoleXrefT(java.math.BigDecimal adminStaffRoleXrefSk, java.sql.Timestamp recCreateTmstp, java.sql.Timestamp recUpdateTmstp, java.sql.Timestamp recEffTmstp, java.sql.Timestamp recTermTmstp, String recCreatedBy, String recUpdatedBy, String changeReasonMemo, java.math.BigDecimal currRecInd, java.math.BigDecimal changeVersionId, String beId, String adminStaffId, String adminStaffRoleName, java.sql.Timestamp adminStaffRoleEffDate, java.sql.Timestamp adminStaffRoleTermDate) throws SQLException
  { _init_struct(true);
    setAdminStaffRoleXrefSk(adminStaffRoleXrefSk);
  ...
  protected ORAData create(AdminStaffRoleXrefT o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new AdminStaffRoleXrefT();
    o._struct = new MutableStruct((STRUCT) d, _sqlType, _factory);
    return o;
  }
  /* accessor methods */
  public java.math.BigDecimal getAdminStaffRoleXrefSk() throws SQLException
  { return (java.math.BigDecimal) _struct.getAttribute(0); }

  public void setAdminStaffRoleXrefSk(java.math.BigDecimal adminStaffRoleXrefSk) throws SQLException
  { _struct.setAttribute(0, adminStaffRoleXrefSk); }
  ...
  { _struct.setAttribute(12, adminStaffRoleName); }
  ...
  { _struct.setAttribute(13, adminStaffRoleEffDate); }
  ...
  { _struct.setAttribute(14, adminStaffRoleTermDate); }
