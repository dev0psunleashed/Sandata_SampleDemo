...
public class BusinessEntityComplianceRelationshipDetailHistory extends BaseObject {
    ...
    @Mapping(getter = "getCompMandComplThreasholdUom", setter = "setCompMandComplThreasholdUom", type = "String", index = 16)
    protected ComplianceMandatoryCompletionThreshold complianceMandatoryCompletionThresholdUnitOfMeasure;
    ...
    public Boolean getComplianceStopRecurringIndicator() {
        return complianceStopRecurringIndicator;
    }

    public void setComplianceStopRecurringIndicator(Boolean complianceStopRecurringIndicator) {
        this.complianceStopRecurringIndicator = complianceStopRecurringIndicator;
    }

    public ComplianceMandatoryCompletionThreshold getComplianceMandatoryCompletionThresholdUnitOfMeasure() {
        return complianceMandatoryCompletionThresholdUnitOfMeasure;
    }

    public void setComplianceMandatoryCompletionThresholdUnitOfMeasure(ComplianceMandatoryCompletionThreshold complianceMandatoryCompletionThresholdUnitOfMeasure) {
        this.complianceMandatoryCompletionThresholdUnitOfMeasure = complianceMandatoryCompletionThresholdUnitOfMeasure;
    }
}
