...
/**
 * <p>Java class for Payer_Modifier_List complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Payer_Modifier_List">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;attribute name="Payer_Modifier_List_SK" use="required" type="{}Surrogate_Key" />
...
@XmlType(name = "Payer_Modifier_List")
@OracleMetadata(
        packageName = "PKG_LOOKUP",
        insertMethod = "insertPayerMdfrLkup",
        updateMethod = "updatePayerMdfrLkup",
        deleteMethod = "deletePayerMdfrLkup",
        getMethod = "getPayerMdfrLkup",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.PayerMdfrLkupT",
        primaryKeys = {})
public class PayerModifierLookup extends BaseObject {

	private static final long serialVersionUID = 1L;

    @XmlAttribute(name = "Payer_Modifier_List_SK", required = true)
    @SerializedName("PayerModifierListSK")
	@Mapping(getter = "getPayerMdfrLstSk", setter = "setPayerMdfrLstSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger payerModifierListSK;
	...
	@Mapping(getter = "getMdfrCode", setter = "setMdfrCode", type = "String", index = 12)
    protected String modifierCode;

    @SerializedName("ModifierShortDescription")
    @Mapping(getter = "getMdfrShortDesc", setter = "setMdfrShortDesc", type = "String", index = 13)
    protected String modifierShortDescription;
    @SerializedName("ModifierLongDescription")
    @Mapping(getter = "getMdfrLongDesc", setter = "setMdfrLongDesc", type = "String", index = 14)
    protected String modifierLongDescription;
    @SerializedName("ModifierEffectiveDate")
    @Mapping(getter = "getMdfrEffDate", setter = "setMdfrEffDate", type = "java.sql.Timestamp", index = 15)
    protected Date modifierEffectiveDate;
    @SerializedName("ModifierTerminationDate")
    @Mapping(getter = "getMdfrTermDate", setter = "setMdfrTermDate", type = "java.sql.Timestamp", index = 16)
    protected Date modifierTerminationDate;

    /**
     * Gets the value of the payerModifierListSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getPayerModifierListSK() {
        return payerModifierListSK;
    }

    /**
     * Sets the value of the payerModifierListSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setPayerModifierListSK(BigInteger value) {
        this.payerModifierListSK = value;
    }
    ...
    public void setModifierShortDescription(String modifierShortDescription) {
        this.modifierShortDescription = modifierShortDescription;
    }
    ...
    public void setModifierLongDescription(String modifierLongDescription) {
        this.modifierLongDescription = modifierLongDescription;
    }
    ...
    public void setModifierEffectiveDate(Date modifierEffectiveDate) {
        this.modifierEffectiveDate = modifierEffectiveDate;
    }
    ...
    public void setModifierTerminationDate(Date modifierTerminationDate) {
        this.modifierTerminationDate = modifierTerminationDate;
    }
}
