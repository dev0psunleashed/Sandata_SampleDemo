...
@XmlType(name = "Staff_Training_Class_Event_Enrollment")
@OracleMetadata(
        packageName = "PKG_STAFF",
        insertMethod = "insertStaffTrngClsEvntEnrol",
        updateMethod = "updateStaffTrngClsEvntEnrol",
        deleteMethod = "deleteStaffTrngClsEvntEnrol",
        getMethod = "getStaffTrngClsEvntEnrol",
        findMethod = "NotDefined_FindMethod",
        jpubClass = "com.sandata.lab.data.model.jpub.model.StaffTrngClsEvntEnrolT",
        primaryKeys = {})
public class StaffTrainingClassEventEnrollment extends BaseObject {

	private static final long serialVersionUID = 1L;

    @XmlAttribute(name = "Staff_Training_Class_Event_Enrollment_SK", required = true)
    @SerializedName("StaffTrainingClassEventEnrollmentSK")
	@Mapping(getter = "getStaffTrngClsEvntEnrolSk", setter = "setStaffTrngClsEvntEnrolSk", type = "java.math.BigDecimal", index = 0)
    protected BigInteger staffTrainingClassEventEnrollmentSK;
	...
	@Mapping(getter = "getStaffTrngLocName", setter = "setStaffTrngLocName", type = "String", index = 13)
	...
	@Mapping(getter = "getStaffTrngCode", setter = "setStaffTrngCode", type = "String", index = 14)
	...
	@Mapping(getter = "getStaffTrngStartDtime", setter = "setStaffTrngStartDtime", type = "java.sql.Timestamp", index = 15)
	...
	@Mapping(getter = "getStaffTrngQlfr", setter = "setStaffTrngQlfr", type = "String", index = 16)
    protected StaffTrainingQualifier staffTrainingQualifier;
    @XmlAttribute(name = "Staff_Training_Drop_Indicator")
    @SerializedName("StaffTrainingDropIndicator")
	@Mapping(getter = "getStaffTrngDropInd", setter = "setStaffTrngDropInd", type = "java.math.BigDecimal", index = 17)
    protected Boolean staffTrainingDropIndicator;

    /**
     * Gets the value of the staffTrainingClassEventEnrollmentSK property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getStaffTrainingClassEventEnrollmentSK() {
        return staffTrainingClassEventEnrollmentSK;
    }

    /**
     * Sets the value of the staffTrainingClassEventEnrollmentSK property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setStaffTrainingClassEventEnrollmentSK(BigInteger value) {
        this.staffTrainingClassEventEnrollmentSK = value;
    }
    ...
    /**
     * Gets the value of the staffTrainingDropIndicator property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isStaffTrainingDropIndicator() {
        return staffTrainingDropIndicator;
    }

    /**
     * Sets the value of the staffTrainingDropIndicator property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setStaffTrainingDropIndicator(Boolean value) {
        this.staffTrainingDropIndicator = value;
    }
