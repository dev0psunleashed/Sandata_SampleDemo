...
import com.sandata.lab.rules.call.matching.aggregate.ResubmitAggregationStrategy;
 ...
 * 
 */
public class ResubmitAggregationStrategyTest extends BaseTestSupport{

    ResubmitAggregationStrategy resubmitAggregationStrategy;
    ...
    protected void onSetup() {
        resubmitAggregationStrategy = new ResubmitAggregationStrategy();
    }
    ...
    public void test_aggregate_first_time_run_StaffFact_instance(){
        ...
        Exchange result = resubmitAggregationStrategy.aggregate(oldExchange, exchange);
    ...
    public void test_aggregate_second_time_run_PatientStaffResponse_instance(){
        ...
        //assertions
        assertEquals("DnisStaffID1", result.getIn().getHeader(PrepForAggregation.DNIS_AND_STAFFID_AND_PATIENT));
