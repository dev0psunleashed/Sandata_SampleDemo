...
public class CallPreferences implements Serializable {
	...
	public static final int DEFAULT_NO_SHOW_RXCEPTION_MINUTES = 30;
	...
	public CallPreferences() {
		...
		setVisitNoShowAlert(DEFAULT_NO_SHOW_RXCEPTION);
		setVisitNoShowMinutes(DEFAULT_NO_SHOW_RXCEPTION_MINUTES);
