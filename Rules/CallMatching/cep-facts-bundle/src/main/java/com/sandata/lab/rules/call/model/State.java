...
public enum State {
	...
	FAILED_9_OF_9_MATCH,
	STAFF_MATCHED_9_OF_9, STAFF_MATCHED_7_OF_9, STAFF_MATCHED_6_OF_9, FAILED_7_OF_9_MATCH,
	...
	VISIT_SHORT,
	LOADED_VSR_5,
	VISIT_NO_SHOW, GPS_EXCP_IN, GPS_EXCP_OUT, TESTING, CONTENDER_SCHEDULED, CONTENDER_UNSCHEDULED, CONTENDER_FROM_REDUCED, CONTENDER_TO_REDUCED;

	public static State getVisitExceptionFromExpectedSk(BigInteger sk) {
		switch(sk.intValue()) {
			case 0:
