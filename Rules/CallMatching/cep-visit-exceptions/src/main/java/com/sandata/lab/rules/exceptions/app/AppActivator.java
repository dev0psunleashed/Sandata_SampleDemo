...
public class AppActivator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
		...
		Logger visitExcpLog = LoggerFactory.getLogger("visitExcpLog");
		visitExcpLog.info(String.format("Started: %s" , getInfo()));
	...
	public void stop(BundleContext context) throws Exception {
		...
		Logger visitExcpLog = LoggerFactory.getLogger("visitExcpLog");
		visitExcpLog.info(String.format("Stopped: %s" , getInfo()));
