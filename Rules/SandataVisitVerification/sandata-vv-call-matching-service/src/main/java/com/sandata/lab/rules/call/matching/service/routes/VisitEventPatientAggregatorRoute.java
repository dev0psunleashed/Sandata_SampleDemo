 ...
 * @author jasonscott
 */
public class VisitEventPatientAggregatorRoute extends AbstractRouteBuilder {
    ...
    @PropertyInject("{{visit.event.patient.agenda.group}}")
    private String callMatchingPatient = "call-matching-patient";
    ...
    protected void buildRoute() {
        ...
        from(getFromEndpointUrl())
            .routeId(App.ID.CALL_MATCHING_VISIT_EVENT_PATIENT_AGGREGATOR.toString())
            ...
            .log(LoggingLevel.INFO, "Completed to aggregate VisitEventFact for patient matching: ${body}")
            .bean(CallMatchingUtil.class, "extractPatientIdAndANI")
            ...
            .log(LoggingLevel.ERROR, "NULL body after patient enrichment!")
            .otherwise()
            .log(LoggingLevel.INFO, "Body after patient enrichment: ${body}")
            .setHeader("agendaGroupName", constant(callMatchingPatient))
    ...
    public String getFromEndpointUrl() {
        ...
        return Messaging.Names.COMPONENT_TYPE_QUEUE.toString()
            + App.ID.CALL_MATCHING_VISIT_EVENT_PATIENT_AGGREGATOR.toString();
    }
